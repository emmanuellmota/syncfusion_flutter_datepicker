...
class _MonthViewState extends State<MonthView> {
  ...
  void initState() {
    ...
    _selectedDates = DateRangePickerHelper.cloneList(_pickerStateDetails.selectedDates);
    _selectedRange = _pickerStateDetails.selectedRange;
    _selectedRanges = DateRangePickerHelper.cloneList(_pickerStateDetails.selectedRanges);
  ...
  void didUpdateWidget(MonthView oldWidget) {
    if (widget.height != oldWidget.height ||
        ...
        !DateRangePickerHelper.isDateCollectionEquals(widget.blackoutDates, oldWidget.blackoutDates) ||
        !DateRangePickerHelper.isDateCollectionEquals(widget.specialDates, oldWidget.specialDates) ||
        widget.showLeadingAndTailingDates != oldWidget.showLeadingAndTailingDates ||
        ...
        widget.extendableRangeSelectionDirection != oldWidget.extendableRangeSelectionDirection) {
      _children.clear();
    }
  ...
  Widget build(BuildContext context) {
    weekNumberPanelWidth = DateRangePickerHelper.getWeekNumberPanelWidth(widget.showWeekNumber, widget.width, widget.isMobilePlatform);
    if (widget.cellBuilder != null && _children.isEmpty) {
      double webUIPadding = 0;
      double width = widget.width - weekNumberPanelWidth;
      double height = widget.height;
      int viewCount = 1;
      final bool isHorizontalMultiView = widget.enableMultiView && widget.navigationDirection == DateRangePickerNavigationDirection.horizontal;
      final bool isVerticalMultiView = widget.enableMultiView && widget.navigationDirection == DateRangePickerNavigationDirection.vertical;
      ...
      final bool hideLeadingAndTrailingDates = (widget.rowCount == 6 && !widget.showLeadingAndTailingDates) || widget.isHijri;
      for (int j = 0; j < viewCount; j++) {
        final int currentViewIndex = widget.isRtl ? DateRangePickerHelper.getRtlIndex(viewCount, j) : j;
        final int viewStartIndex = j * datesCount;
        final int currentMonth = widget.visibleDates[(viewStartIndex + (datesCount / 2)).truncate()].month as int;

        double viewStartPosition =
            isVerticalMultiView ? weekNumberPanelWidth : (currentViewIndex * width) + (currentViewIndex * widget.multiViewSpacing) + (weekNumberPanelWidth * (viewStartIndex + 1));
        if (widget.isRtl) {
        ...
        double yPosition = isHorizontalMultiView ? 0 : (currentViewIndex * height) + (currentViewIndex * widget.multiViewSpacing);
        for (int i = 0; i < datesCount; i++) {
          int currentIndex = i;
          if (widget.isRtl) {
            final int rowIndex = i ~/ DateTime.daysPerWeek;
            currentIndex = DateRangePickerHelper.getRtlIndex(DateTime.daysPerWeek, i % DateTime.daysPerWeek) + (rowIndex * DateTime.daysPerWeek);
          }
          ...
          final Widget child = widget.cellBuilder(
              ...
              widget.isHijri
                  ? HijriDateRangePickerCellDetails(
                      date: date, visibleDates: widget.visibleDates.cast<HijriDateTime>(), bounds: Rect.fromLTWH(xPosition, yPosition, cellWidth, cellHeight))
                  : DateRangePickerCellDetails(
                      date: date, visibleDates: widget.visibleDates.cast<DateTime>(), bounds: Rect.fromLTWH(xPosition, yPosition, cellWidth, cellHeight))) as Widget;
          _children.add(child);
          xPosition += cellWidth;
        }
      }
  ...
  bool _isSelectedValueEquals() {
    switch (widget.selectionMode) {
      ...
      case DateRangePickerSelectionMode.multiple:
        {
          return DateRangePickerHelper.isDateCollectionEquals(_selectedDates, _pickerStateDetails.selectedDates);
        }
      case DateRangePickerSelectionMode.range:
      case DateRangePickerSelectionMode.extendableRange:
        {
          return DateRangePickerHelper.isRangeEquals(_selectedRange, _pickerStateDetails.selectedRange);
        }
      case DateRangePickerSelectionMode.multiRange:
        {
          return DateRangePickerHelper.isDateRangesEquals(_selectedRanges, _pickerStateDetails.selectedRanges);
        }
    }
  }
...
class _MonthViewSingleSelectionRenderWidget extends MultiChildRenderObjectWidget {
  ...
  @override
  _MonthViewSingleSelectionRenderObject createRenderObject(BuildContext context) {
  ...
  @override
  void updateRenderObject(BuildContext context, _MonthViewSingleSelectionRenderObject renderObject) {
    renderObject
...
class _MonthViewMultiSelectionRenderWidget extends MultiChildRenderObjectWidget {
  ...
  @override
  _MonthViewMultiSelectionRenderObject createRenderObject(BuildContext context) {
  ...
  @override
  void updateRenderObject(BuildContext context, _MonthViewMultiSelectionRenderObject renderObject) {
    renderObject
      ..visibleDates = visibleDates
      ..rowCount = rowCount
      ..cellStyle = cellStyle
...
class _MonthViewRangeSelectionRenderWidget extends MultiChildRenderObjectWidget {
  ...
  @override
  _MonthViewRangeSelectionRenderObject createRenderObject(BuildContext context) {
  ...
  @override
  void updateRenderObject(BuildContext context, _MonthViewRangeSelectionRenderObject renderObject) {
    renderObject
      ..visibleDates = visibleDates
      ..rowCount = rowCount
      ..cellStyle = cellStyle
...
class _MonthViewExtendableRangeSelectionRenderWidget extends MultiChildRenderObjectWidget {
  ...
  @override
  _MonthViewExtendableRangeSelectionRenderObject createRenderObject(BuildContext context) {
  ...
  @override
  void updateRenderObject(BuildContext context, _MonthViewExtendableRangeSelectionRenderObject renderObject) {
    renderObject
      ..visibleDates = visibleDates
      ..rowCount = rowCount
      ..cellStyle = cellStyle
...
class _MonthViewMultiRangeSelectionRenderWidget extends MultiChildRenderObjectWidget {
  ...
  @override
  _MonthViewMultiRangeSelectionRenderObject createRenderObject(BuildContext context) {
  ...
  @override
  void updateRenderObject(BuildContext context, _MonthViewMultiRangeSelectionRenderObject renderObject) {
    renderObject
      ..visibleDates = visibleDates
      ..rowCount = rowCount
      ..cellStyle = cellStyle
...
abstract class _IMonthView extends RenderBox with ContainerRenderObjectMixin<RenderBox, _DatePickerParentData> {
  _IMonthView(
      this._visibleDates,
      this._rowCount,
      this._cellStyle,
  ...
  DateRangePickerNavigationDirection get navigationDirection => _navigationDirection;
  ...
  final TextPainter _textPainter = TextPainter(textDirection: TextDirection.ltr, textWidthBasis: TextWidthBasis.longestLine);
  ...
  void performLayout() {
    ...
    if (_enableMultiView) {
      if (_navigationDirection == DateRangePickerNavigationDirection.horizontal) {
        currentWidth = (currentWidth - multiViewSpacing - weekNumberPanelWidth) / 2;
      } else {
    ...
    while (child != null) {
      child.layout(constraints.copyWith(minHeight: cellHeight, maxHeight: cellHeight, minWidth: cellWidth, maxWidth: cellWidth));
  ...
  /// value(date, dates, range, ranges).
  TextStyle drawSelection(Canvas canvas, double x, double y, int index, TextStyle selectionTextStyle, TextStyle selectionRangeTextStyle);
  ...
  List<CustomPainterSemantics> _getSemanticsBuilder(Size size) {
    ...
    int viewCount = 1;
    final bool isHorizontalMultiView = _enableMultiView && _navigationDirection == DateRangePickerNavigationDirection.horizontal;
    final bool isVerticalMultiView = _enableMultiView && _navigationDirection == DateRangePickerNavigationDirection.vertical;
    ...
    final double cellWidth = (width - weekNumberPanelWidth) / DateTime.daysPerWeek;
    final double cellHeight = height / rowCount;
    final int datesCount = _visibleDates.length ~/ viewCount;
    for (int j = 0; j < viewCount; j++) {
      final int currentViewIndex = _isRtl ? DateRangePickerHelper.getRtlIndex(viewCount, j) : j;
      left = _isRtl ? width - cellWidth - weekNumberPanelWidth : weekNumberPanelWidth;
      top = 0;
      final dynamic middleDate = _visibleDates[(j * datesCount) + (datesCount ~/ 2)];
      double viewXStartPosition =
          isVerticalMultiView ? weekNumberPanelWidth : (currentViewIndex * width) + (currentViewIndex * webUIPadding) + (weekNumberPanelWidth * (currentViewIndex + 1));
      if (isRtl) {
      ...
      final double viewYStartPosition = isHorizontalMultiView ? 0 : (currentViewIndex * height) + (currentViewIndex * _multiViewSpacing);

      for (int i = 0; i < datesCount; i++) {
        final dynamic currentDate = _visibleDates[(j * datesCount) + i];

        if (weekNumberPanelWidth != 0 && currentDate.weekday == DateTime.monday) {
          ...
          if (isHorizontalMultiView || isVerticalMultiView) {
            ...
            xPosition = isHorizontalMultiView ? viewXStartPosition - weekNumberPanelWidth : xPosition;
          }
          final int weekNumber = DateRangePickerHelper.getWeekNumberOfYear(currentDate, isHijri);
          semanticsBuilder.add(CustomPainterSemantics(
              rect: Rect.fromLTWH(xPosition, top, weekNumberPanelWidth, cellHeight),
        ...
        if (!DateRangePickerHelper.isDateAsCurrentMonthDate(middleDate, _rowCount, _showLeadingAndTailingDates, currentDate, _isHijri)) {
          leftAndTopValue = DateRangePickerHelper.getTopAndLeftValues(_isRtl, left, top, cellWidth, cellHeight, width);
          left = leftAndTopValue['left']!;
          top = leftAndTopValue['top']!;
          continue;
        } else if (DateRangePickerHelper.isDateWithInVisibleDates(_visibleDates, _blackoutDates, currentDate)) {
          semanticsBuilder.add(CustomPainterSemantics(
            rect: Rect.fromLTWH(viewXStartPosition + left, viewYStartPosition + top, cellWidth, cellHeight),
            properties: SemanticsProperties(
          ...
          top = leftAndTopValue['top']!;
          continue;
        } else if (!DateRangePickerHelper.isEnabledDate(_minDate, _maxDate, _enablePastDates, currentDate, _isHijri) ||
            DateRangePickerHelper.isDateWithInVisibleDates(visibleDates, disableDatesCollection, currentDate)) {
          semanticsBuilder.add(CustomPainterSemantics(
            rect: Rect.fromLTWH(viewXStartPosition + left, viewYStartPosition + top, cellWidth, cellHeight),
            properties: SemanticsProperties(
...
class _MonthViewSingleSelectionRenderObject extends _IMonthView {
    ...
    if (enableMultiView) {
      switch (_navigationDirection) {
        case DateRangePickerNavigationDirection.horizontal:
          {
            _cellWidth = (size.width - _multiViewSpacing - (weekNumberPanelWidth * 2)) / (DateTime.daysPerWeek * 2);
          }
          break;
  ...
  TextStyle drawSelection(Canvas canvas, double x, double y, int index, TextStyle selectionTextStyle, TextStyle selectionRangeTextStyle) {
    ...
    switch (selectionShape) {
      case DateRangePickerSelectionShape.circle:
        {
          final double radius = _getCellRadius(selectionRadius, _centerXPosition, _centerYPosition);
          _drawCircleSelection(canvas, x + _centerXPosition, y + _centerYPosition, radius, _selectionPainter);
        }
        break;
      case DateRangePickerSelectionShape.rectangle:
        {
          _drawFillSelection(canvas, x, y, _cellWidth, _cellHeight, _selectionPainter);
        }
    }
  ...
  void drawCustomCellSelection(Canvas canvas, double x, double y, int index) {
    ...
    _selectionPainter.isAntiAlias = true;
    canvas.drawRect(Rect.fromLTRB(x, y, x + _cellWidth, y + _cellHeight), _selectionPainter);
  }
  ...
  List<int> getSelectedIndexValues(int viewStartIndex, int viewEndIndex) {
    ...
    if (selectedDate != null) {
      if (isDateWithInDateRange(visibleDates[viewStartIndex], visibleDates[viewEndIndex], selectedDate)) {
        final int index = _getSelectedIndex(selectedDate, visibleDates, viewStartIndex: viewStartIndex);
...
class _MonthViewMultiSelectionRenderObject extends _IMonthView {
  ...
  List<int> getSelectedIndexValues(int viewStartIndex, int viewEndIndex) {
    ...
    if (selectedDates != null) {
      for (int j = 0; j < selectedDates!.length; j++) {
        ...
        if (!isDateWithInDateRange(visibleDates[viewStartIndex], visibleDates[viewEndIndex], date)) {
          continue;
        }

        selectedIndex.add(_getSelectedIndex(date, visibleDates, viewStartIndex: viewStartIndex));
      }
    }
  ...
  @override
  void updateSelection(PickerStateArgs details) {
    if (DateRangePickerHelper.isDateCollectionEquals(details.selectedDates, selectedDates)) {
      return;
    }
...
class _MonthViewRangeSelectionRenderObject extends _IMonthView {
  ...
  TextStyle drawSelection(Canvas canvas, double x, double y, int index, TextStyle selectionTextStyle, TextStyle selectionRangeTextStyle) {
    ...
    if (isSelectedDate) {
      _drawSelectedDate(canvas, radius, _centerXPosition, _cellWidth, _cellHeight, x, y, this, _centerYPosition);
    } else if (isStartRange) {
      _selectionPainter.color = rangeSelectionColor ?? datePickerTheme.rangeSelectionColor!;
      _drawStartAndEndRange(canvas, this, _cellHeight, _cellWidth, radius, _centerXPosition, _centerYPosition, x, y,
          startRangeSelectionColor ?? datePickerTheme.startRangeSelectionColor!, heightDifference, isStartRange);
    } else if (isEndRange) {
      _selectionPainter.color = rangeSelectionColor ?? datePickerTheme.rangeSelectionColor!;
      _drawStartAndEndRange(canvas, this, _cellHeight, _cellWidth, radius, _centerXPosition, _centerYPosition, x, y,
          endRangeSelectionColor ?? datePickerTheme.endRangeSelectionColor!, heightDifference, isStartRange);
    } else if (isBetweenRange) {
      return _drawBetweenSelection(canvas, this, _cellWidth, _cellHeight, radius, x, y, heightDifference, selectionRangeTextStyle);
    }
  ...
  void drawCustomCellSelection(Canvas canvas, double x, double y, int index) {
    ...
    final bool isBetweenRange = selectionDetails[3];
    if (isSelectedDate) {
      _selectionPainter.color = startRangeSelectionColor ?? datePickerTheme.startRangeSelectionColor!;
    } else if (isStartRange) {
      _selectionPainter.color = startRangeSelectionColor ?? datePickerTheme.startRangeSelectionColor!;
    } else if (isEndRange) {
      _selectionPainter.color = endRangeSelectionColor ?? datePickerTheme.endRangeSelectionColor!;
    } else if (isBetweenRange) {
      _selectionPainter.color = rangeSelectionColor ?? datePickerTheme.rangeSelectionColor!;
    }
  ...
  List<int> getSelectedIndexValues(int viewStartIndex, int viewEndIndex) {
    ...
    if (selectedRange != null) {
      ...
      _selectedIndex = _getSelectedRangeIndex(startDate, endDate, visibleDates, isHijri, monthStartIndex: viewStartIndex, monthEndIndex: viewEndIndex);
    }
  ...
  @override
  void updateSelection(PickerStateArgs details) {
    if (DateRangePickerHelper.isRangeEquals(details.selectedRange, selectedRange)) {
      return;
    }
...
class _MonthViewExtendableRangeSelectionRenderObject extends _IMonthView {
  ...
  ExtendableRangeSelectionDirection get extendableRangeSelectionDirection => _extendableRangeSelectionDirection;

  set extendableRangeSelectionDirection(ExtendableRangeSelectionDirection value) {
  ...
  @override
  TextStyle drawSelection(Canvas canvas, double x, double y, int index, TextStyle selectionTextStyle, TextStyle selectionRangeTextStyle) {
    final List<bool> selectionDetails = _getSelectedRangePosition(index, _selectedIndex);
    final bool isSelectedDate = selectionDetails[0];
    final bool isStartRange = selectionDetails[1];
    final bool isEndRange = selectionDetails[2];
    final bool isBetweenRange = selectionDetails[3];
...
class _MonthViewMultiRangeSelectionRenderObject extends _IMonthView {
  ...
  List<int> getSelectedIndexValues(int viewStartIndex, int viewEndIndex) {
    ...
    if (selectedRanges != null) {
      for (int j = 0; j < selectedRanges!.length; j++) {
        ...
        final List<int> rangeIndex = _getSelectedRangeIndex(startDate, endDate, visibleDates, isHijri, monthStartIndex: viewStartIndex, monthEndIndex: viewEndIndex);
  ...
  @override
  void updateSelection(PickerStateArgs details) {
    if (DateRangePickerHelper.isDateRangesEquals(details.selectedRanges, selectedRanges)) {
      return;
    }
...
void _drawSelectedDate(Canvas canvas, double radius, double centerXPosition, double cellWidth, double cellHeight, double x, double y, _IMonthView view, double centerYPosition) {
  view._selectionPainter.isAntiAlias = true;
  view._selectionPainter.color = view.startRangeSelectionColor ?? view.datePickerTheme.startRangeSelectionColor!;
  switch (view.selectionShape) {
    case DateRangePickerSelectionShape.circle:
      {
        _drawCircleSelection(canvas, x + centerXPosition, y + centerYPosition, radius, view._selectionPainter);
      }
      break;
    case DateRangePickerSelectionShape.rectangle:
      {
        _drawFillSelection(canvas, x, y, cellWidth, cellHeight, view._selectionPainter);
      }
  }
}

void _drawStartAndEndRange(Canvas canvas, _IMonthView view, double cellHeight, double cellWidth, double radius, double centerXPosition, double centerYPosition, double x, double y,
    Color color, double heightDifference, bool isStartRange) {
  switch (view.selectionShape) {
    case DateRangePickerSelectionShape.circle:
      {
        Rect rect;
        if (isStartRange) {
          rect = Rect.fromLTRB(x + centerXPosition, y + heightDifference, x + cellWidth, y + cellHeight - heightDifference);
        } else {
          rect = Rect.fromLTRB(x, y + heightDifference, x + centerXPosition, y + cellHeight - heightDifference);
        }

        _drawStartEndRangeCircleSelection(canvas, x + centerXPosition, y + centerYPosition, radius, rect, view._selectionPainter, color);
      }
      break;
    case DateRangePickerSelectionShape.rectangle:
      {
        ...
        if (isStartRange) {
          _drawStartRangeFillSelection(canvas, x, y, cellWidth, cellHeight, view._selectionPainter);
        } else {
          _drawEndRangeFillSelection(canvas, x, y, cellWidth, cellHeight, view._selectionPainter);
        }
      }
  }
}
...
TextStyle _drawBetweenSelection(
    Canvas canvas, _IMonthView view, double cellWidth, double cellHeight, double radius, double x, double y, double heightDifference, TextStyle selectionRangeTextStyle) {
  switch (view.selectionShape) {
    case DateRangePickerSelectionShape.rectangle:
      heightDifference = 1;
      break;
  ...
  view._selectionPainter.color = view.rangeSelectionColor ?? view.datePickerTheme.rangeSelectionColor!;
  _drawRectRangeSelection(canvas, x, y + heightDifference, x + cellWidth, y + cellHeight - heightDifference, view._selectionPainter);
  return selectionRangeTextStyle;
}

double _getCellRadius(double selectionRadius, double maxXRadius, double maxYRadius) {
  final double radius = maxXRadius > maxYRadius ? maxYRadius - _IMonthView._selectionPadding : maxXRadius - _IMonthView._selectionPadding;
...
List<int> _getSelectedRangeIndex(dynamic startDate, dynamic endDate, List<dynamic> visibleDates, bool isHijri, {int monthStartIndex = -1, int monthEndIndex = -1}) {
  int startIndex = -1;
  int endIndex = -1;
  final List<int> selectedIndex = <int>[];
  ...
  if (endDate != null) {
    endRangeDate = DateRangePickerHelper.getDate(endDate.year, endDate.month, endDate.day, isHijri);
  }
  ...
  final dynamic viewStartDate = monthStartIndex != -1 ? visibleDates[monthStartIndex] : visibleDates[0];
  final dynamic viewEndDate = monthEndIndex != -1 ? visibleDates[monthEndIndex] : visibleDates[visibleDates.length - 1];
  if (startDate != null) {
    if (viewStartDate.isAfter(startDate) == true && viewStartDate.isBefore(endRangeDate) == true) {
      startIndex = -1;
    } else {
      startIndex = _getSelectedIndex(startDate, visibleDates, viewStartIndex: monthStartIndex);
    }
  }

  if (endRangeDate != null) {
    if (viewEndDate.isAfter(startDate) == true && viewEndDate.isBefore(endRangeDate) == true) {
      endIndex = visibleDates.length;
    } else {
      endIndex = _getSelectedIndex(endRangeDate, visibleDates, viewStartIndex: monthStartIndex);
    }
  }
...
int _getSelectedIndex(dynamic date, List<dynamic> visibleDates, {int viewStartIndex = 0}) {
  if (viewStartIndex == -1) {
    viewStartIndex = 0;
  }
...
void _drawCircleSelection(Canvas canvas, double x, double y, double radius, Paint selectionPainter) {
  canvas.drawCircle(Offset(x, y), radius, selectionPainter);
}

void _drawFillSelection(Canvas canvas, double x, double y, double width, double height, Paint selectionPainter) {
  const double padding = 1;
  canvas.drawRRect(RRect.fromRectAndRadius(Rect.fromLTRB(x + padding, y + padding, x + width - padding, y + height - padding), Radius.circular(height / 4 > 10 ? 10 : height / 4)),
      selectionPainter);
}

void _drawStartRangeFillSelection(Canvas canvas, double x, double y, double width, double height, Paint selectionPainter) {
  const double padding = 1;
  final double cornerRadius = height / 4 > 10 ? 10 : height / 4;
  canvas.drawRRect(
      RRect.fromRectAndCorners(Rect.fromLTRB(x + padding, y + padding, x + width, y + height - padding),
          bottomLeft: Radius.circular(cornerRadius), topLeft: Radius.circular(cornerRadius)),
      selectionPainter);
}

void _drawEndRangeFillSelection(Canvas canvas, double x, double y, double width, double height, Paint selectionPainter) {
  const double padding = 1;
  final double cornerRadius = height / 4 > 10 ? 10 : height / 4;
  canvas.drawRRect(
      RRect.fromRectAndCorners(Rect.fromLTRB(x, y + padding, x + width - padding, y + height - padding),
          bottomRight: Radius.circular(cornerRadius), topRight: Radius.circular(cornerRadius)),
      selectionPainter);
}

void _drawStartEndRangeCircleSelection(Canvas canvas, double x, double y, double radius, Rect rect, Paint selectionPainter, Color color) {
...
void _drawRectRangeSelection(Canvas canvas, double left, double top, double right, double bottom, Paint selectionPainter) {
  canvas.drawRect(Rect.fromLTRB(left, top, right, bottom), selectionPainter);
}

void _drawMonthCellsAndSelection(PaintingContext context, Size size, _IMonthView monthView, double cellWidth, double cellHeight) {
  ...
  double height = size.height;
  int viewCount = 1;
  final bool isHorizontalMultiView = monthView.enableMultiView && monthView.navigationDirection == DateRangePickerNavigationDirection.horizontal;
  final bool isVerticalMultiView = monthView.enableMultiView && monthView.navigationDirection == DateRangePickerNavigationDirection.vertical;
  ...
  TextStyle textStyle = monthView.cellStyle.textStyle as TextStyle? ?? monthView.datePickerTheme.activeDatesTextStyle!;
  final int datesCount = monthView.visibleDates.length ~/ viewCount;
  final bool isNeedWidgetPaint = monthView.childCount != 0;
  final bool hideLeadingAndTrailingDates = (monthView.rowCount == 6 && !monthView.showLeadingAndTailingDates) || monthView.isHijri;
  if (isNeedWidgetPaint) {
    RenderBox? child = monthView.firstChild;
    if (!isHorizontalMultiView) {
      _drawWeekNumberPanel(canvas, size, weekNumberPanelWidth, monthView, isHorizontalMultiView);
    }
    for (int j = 0; j < viewCount; j++) {
      final int currentViewIndex = monthView.isRtl ? DateRangePickerHelper.getRtlIndex(viewCount, j) : j;
      final int currentMonth = monthView.visibleDates[((j * datesCount) + (datesCount / 2)).truncate()].month as int;

      final int viewStartIndex = j * datesCount;
      final int viewEndIndex = ((j + 1) * datesCount) - 1;
      final List<int> selectedIndex = monthView.getSelectedIndexValues(viewStartIndex, viewEndIndex);
      double viewStartPosition =
          isVerticalMultiView ? weekNumberPanelWidth : (currentViewIndex * width) + (currentViewIndex * webUIPadding) + (weekNumberPanelWidth * (currentViewIndex + 1));
      if (monthView.isRtl) {
        viewStartPosition = isVerticalMultiView ? 0 : (currentViewIndex * width) + (currentViewIndex * webUIPadding) + (weekNumberPanelWidth * currentViewIndex);
      ...
      final double viewEndPosition = viewStartPosition + width;
      xPosition = viewStartPosition;
      yPosition = isHorizontalMultiView ? 0 : (currentViewIndex * height) + (currentViewIndex * webUIPadding);
      ...
      if (isHorizontalMultiView) {
        _drawWeekNumberPanel(canvas, size, weekNumberPanelWidth, monthView, isHorizontalMultiView,
            viewStartPosition: monthView.isRtl ? (viewEndPosition + weekNumberPanelWidth + (j * webUIPadding)) : viewStartPosition);
      }
      ...
      for (int i = 0; i < datesCount; i++) {
        ...
        if (weekNumberPanelWidth != 0 &&
            ...
            ((i <= DateTime.daysPerWeek && monthView.visibleDates[viewStartIndex + DateTime.daysPerWeek].month == currentMonth) ||
                (i > DateTime.daysPerWeek && i <= (DateTime.daysPerWeek * 2) && monthView.visibleDates[viewStartIndex + (DateTime.daysPerWeek * 2)].month == currentMonth) ||
                (i >= datesCount - (DateTime.daysPerWeek * 2) &&
                    i < datesCount - DateTime.daysPerWeek &&
                    monthView.visibleDates[viewEndIndex - ((DateTime.daysPerWeek * 2) - 1)].month == currentMonth) ||
                (i >= datesCount - DateTime.daysPerWeek && (monthView.visibleDates[viewEndIndex - (DateTime.daysPerWeek - 1)].month == currentMonth))) &&
            date.weekday == DateTime.monday) {
          _drawWeekNumber(canvas, size, date, cellHeight, yPosition, weekNumberPanelWidth, monthView, viewStartPosition, viewEndPosition);
        }
        ...
        final bool isEnableDate = DateRangePickerHelper.isEnabledDate(monthView.minDate, monthView.maxDate, monthView.enablePastDates, date, monthView.isHijri);

        final bool isBlackedDate = DateRangePickerHelper.isDateWithInVisibleDates(monthView.visibleDates, monthView.blackoutDates, date);
        final bool isSelectedDate = selectedIndex.contains(currentIndex);
        bool isDisabledDate = DateRangePickerHelper.isDateWithInVisibleDates(monthView.visibleDates, monthView.disableDatesCollection, date);
        if (!isDisabledDate &&
            monthView is _MonthViewExtendableRangeSelectionRenderObject &&
            monthView.selectedRange != null &&
            DateRangePickerHelper.isDisableDirectionDate(monthView.selectedRange, date, monthView.extendableRangeSelectionDirection, DateRangePickerView.month, monthView.isHijri,
        ...
        if (weekNumberPanelWidth != 0 &&
            date.weekday == DateTime.monday &&
            (!hideLeadingAndTrailingDates || (hideLeadingAndTrailingDates && (i > (DateTime.daysPerWeek * 2)) && (i < datesCount - (DateTime.daysPerWeek * 2))))) {
          _drawWeekNumber(canvas, size, date, cellHeight, yPosition, weekNumberPanelWidth, monthView, viewStartPosition, viewEndPosition);
        }

        if (monthView.mouseHoverPosition.value != null && monthView.mouseHoverPosition.value!.offset != null) {
          if ((isSelectedDate && (!monthView.isBetweenRange(currentIndex))) || isBlackedDate || !isEnableDate || isDisabledDate) {
            xPosition += cellWidth;
            continue;
          }
          ...
          if (xPosition <= monthView.mouseHoverPosition.value!.offset!.dx &&
              ...
              yPosition + cellHeight >= monthView.mouseHoverPosition.value!.offset!.dy) {
            ...
            monthView._selectionPainter.color =
                monthView.selectionColor != null ? monthView.selectionColor!.withOpacity(0.4) : monthView.datePickerTheme.selectionColor!.withOpacity(0.4);
            canvas.drawRRect(RRect.fromRectAndRadius(Rect.fromLTWH(xPosition, yPosition, cellWidth, cellHeight), const Radius.circular(2)), monthView._selectionPainter);
          }
        }
  ...
  for (int j = 0; j < viewCount; j++) {
    final int currentViewIndex = monthView.isRtl ? DateRangePickerHelper.getRtlIndex(viewCount, j) : j;
    final dynamic currentMonthDate = monthView.visibleDates[((j * datesCount) + (datesCount / 2)).truncate()];
    final int nextMonth = getNextMonthDate(currentMonthDate).month as int;
    final int previousMonth = getPreviousMonthDate(currentMonthDate).month as int;
    bool isCurrentDate;
    final TextStyle selectionTextStyle = monthView.selectionTextStyle ?? monthView.datePickerTheme.selectionTextStyle!;
    final TextStyle selectedRangeTextStyle = monthView.rangeTextStyle ?? monthView.datePickerTheme.rangeSelectionTextStyle!;
    ...
    if (monthView.mouseHoverPosition.value != null && monthView.mouseHoverPosition.value!.hoveringRange != null) {
      hoveringIndex = _getSelectedRangeIndex(
          monthView.mouseHoverPosition.value!.hoveringRange.startDate, monthView.mouseHoverPosition.value!.hoveringRange.endDate, monthView.visibleDates, monthView.isHijri,
    ...
    for (int i = 0; i < datesCount; i++) {
      ...
      if (weekNumberPanelWidth != 0 &&
          hideLeadingAndTrailingDates &&
          ((i <= DateTime.daysPerWeek && monthView.visibleDates[viewStartIndex + DateTime.daysPerWeek].month == currentMonthDate.month) ||
              (i > DateTime.daysPerWeek &&
                  i <= (DateTime.daysPerWeek * 2) &&
                  monthView.visibleDates[viewStartIndex + (DateTime.daysPerWeek * 2)].month == currentMonthDate.month) ||
              (i >= datesCount - (DateTime.daysPerWeek * 2) &&
                  i < datesCount - DateTime.daysPerWeek &&
                  monthView.visibleDates[viewEndIndex - ((DateTime.daysPerWeek * 2) - 1)].month == currentMonthDate.month) ||
              (i >= datesCount - DateTime.daysPerWeek && (monthView.visibleDates[viewEndIndex - (DateTime.daysPerWeek - 1)].month == currentMonthDate.month))) &&
          date.weekday == DateTime.monday) {
        _drawWeekNumber(canvas, size, date, cellHeight, yPosition, weekNumberPanelWidth, monthView, viewStartPosition, viewEndPosition);
      }
      ...
      final bool isBlackedDate = DateRangePickerHelper.isDateWithInVisibleDates(monthView.visibleDates, monthView.blackoutDates, date);
      final bool isWeekEnd = DateRangePickerHelper.isWeekend(monthView.weekendDays, date);
      final bool isSpecialDate = DateRangePickerHelper.isDateWithInVisibleDates(monthView.visibleDates, monthView.specialDates, date);
      bool isDisabledDate = DateRangePickerHelper.isDateWithInVisibleDates(monthView.visibleDates, monthView.disableDatesCollection, date);
      if (!isDisabledDate &&
          monthView is _MonthViewExtendableRangeSelectionRenderObject &&
          monthView.selectedRange != null &&
      ...
      textStyle = _updateTextStyle(monthView, isNextMonth, isPreviousMonth, isCurrentDate, isEnableDate, isBlackedDate, isWeekEnd, isSpecialDate, isDisabledDate);
      dateDecoration = _updateDecoration(isNextMonth, isPreviousMonth, monthView, isEnableDate, isCurrentDate, isBlackedDate, date, isWeekEnd, isSpecialDate, isDisabledDate);
      ...
      if (isSelectedDate &&
          ...
          isEnableDate &&
          !isDisabledDate &&
          (!monthView.enableMultiView || (monthView.rowCount != 6 || (currentMonthDate.month == currentDateMonth)))) {
        textStyle = _drawCellAndSelection(canvas, xPosition, yPosition, selectionTextStyle, selectedRangeTextStyle, monthView, currentIndex);
      } else if (dateDecoration != null) {
        _drawDecoration(canvas, xPosition, yPosition, padding, cellWidth, cellHeight, dateDecoration, monthView);
      } else if (isCurrentDate) {
        _drawCurrentDate(canvas, monthView, xPosition, yPosition, padding, cellWidth, cellHeight);
      }
      ...
      monthView._textPainter.paint(canvas, Offset(xPosition + (cellWidth / 2 - monthView._textPainter.width / 2), yPosition + ((cellHeight - monthView._textPainter.height) / 2)));

      if (hoveringIndex != null && hoveringIndex.isNotEmpty && hoveringIndex.contains(currentIndex) && !isBlackedDate && isEnableDate) {
        _addRangeHoverEffect(canvas, xPosition, yPosition, monthView, currentIndex, hoveringIndex);
      }
      ...
      if (monthView.mouseHoverPosition.value != null) {
        ...
        if (monthView.mouseHoverPosition.value!.offset != null) {
          _addHoveringEffect(canvas, monthView, xPosition, yPosition, cellWidth, cellHeight, size);
        }
      }
...
void _drawWeekNumber(Canvas canvas, Size size, dynamic date, double cellHeight, double yPosition, double weekNumberPanelWidth, _IMonthView monthView, double viewStartPosition,
    double viewEndPosition) {
  final String weekNumber = DateRangePickerHelper.getWeekNumberOfYear(date, monthView.isHijri).toString();
  final TextStyle weekNumberTextStyle = monthView.weekNumberStyle.textStyle ?? monthView.datePickerTheme.weekNumberTextStyle!;
  ...
  double weekNumberPosition = (weekNumberPanelWidth - monthView._textPainter.width) / 2;
  weekNumberPosition += monthView.isRtl
      ? viewStartPosition == 0 && monthView.navigationDirection == DateRangePickerNavigationDirection.horizontal
          ? viewEndPosition + monthView.multiViewSpacing
          : viewEndPosition
      : viewStartPosition - weekNumberPanelWidth;
  monthView._textPainter.paint(canvas, Offset(weekNumberPosition, yPosition + ((cellHeight - monthView._textPainter.height) / 2)));
}

void _drawWeekNumberPanel(Canvas canvas, Size size, double weekNumberPanelWidth, _IMonthView monthView, bool isHorizontalMultiView, {double viewStartPosition = 0}) {
  if (weekNumberPanelWidth == 0) {
    return;
  }
  ...
  final Rect rect = Rect.fromLTRB(xPosition + padding, padding, (xPosition + weekNumberPanelWidth) - padding, size.height - padding);
  final Paint _linePainter = Paint();
  _linePainter.style = PaintingStyle.fill;
  _linePainter.color = monthView.weekNumberStyle.backgroundColor ?? monthView.datePickerTheme.weekNumberBackgroundColor!;
...
void _addRangeHoverEffect(Canvas canvas, double xPosition, double yPosition, _IMonthView monthView, int currentIndex, List<int>? hoveringIndex) {
  ...
  final List<bool> hoveringDetails = rangeSelectionMonthView._getSelectedRangePosition(currentIndex, hoveringIndex);
  ...
  final double radius = _getCellRadius(rangeSelectionMonthView.selectionRadius, rangeSelectionMonthView._centerXPosition, rangeSelectionMonthView._centerYPosition);
  final double cornerRadius = monthView._cellHeight / 4 > 10 ? 10 : monthView._cellHeight / 4;
  ...
  if (isStartRange) {
    switch (monthView.selectionShape) {
      case DateRangePickerSelectionShape.circle:
        rect = Rect.fromLTRB(xPosition + rangeSelectionMonthView._centerXPosition, yPosition + heightDifference, xPosition + rangeSelectionMonthView._cellWidth,
            yPosition + rangeSelectionMonthView._cellHeight - heightDifference);
        break;
      case DateRangePickerSelectionShape.rectangle:
        final double rightPosition = xPosition + rangeSelectionMonthView._cellWidth;
        rect = Rect.fromLTRB(rightPosition - cornerRadius, yPosition + heightDifference, rightPosition, yPosition + rangeSelectionMonthView._cellHeight - heightDifference);
    }
  } else if (isEndRange) {
    switch (monthView.selectionShape) {
      case DateRangePickerSelectionShape.circle:
        rect = Rect.fromLTRB(
            xPosition, yPosition + heightDifference, xPosition + rangeSelectionMonthView._centerXPosition, yPosition + rangeSelectionMonthView._cellHeight - heightDifference);
        break;
      case DateRangePickerSelectionShape.rectangle:
        {
          rect = Rect.fromLTRB(xPosition, yPosition + heightDifference, xPosition + cornerRadius, yPosition + rangeSelectionMonthView._cellHeight - heightDifference);
        }
    }
  } else if (isBetweenRange) {
    rect =
        Rect.fromLTRB(xPosition, yPosition + heightDifference, xPosition + rangeSelectionMonthView._cellWidth, yPosition + rangeSelectionMonthView._cellHeight - heightDifference);
  }

  monthView._selectionPainter.style = PaintingStyle.stroke;
  monthView._selectionPainter.strokeWidth = 1.0;
  monthView._selectionPainter.color = monthView.selectionColor != null ? monthView.selectionColor!.withOpacity(0.4) : monthView.datePickerTheme.selectionColor!.withOpacity(0.4);
  DateRangePickerHelper.drawDashedLine(rect.left, rect.top, rect.right, canvas, monthView._selectionPainter);
  DateRangePickerHelper.drawDashedLine(rect.left, rect.bottom, rect.right, canvas, monthView._selectionPainter);
}

void _addHoveringEffect(Canvas canvas, _IMonthView monthView, double xPosition, double yPosition, double cellWidth, double cellHeight, Size size) {
  if (xPosition <= monthView.mouseHoverPosition.value!.offset!.dx &&
      xPosition + cellWidth >= monthView.mouseHoverPosition.value!.offset!.dx &&
      yPosition <= monthView.mouseHoverPosition.value!.offset!.dy &&
      yPosition + cellHeight >= monthView.mouseHoverPosition.value!.offset!.dy) {
      ...
      case DateRangePickerSelectionShape.circle:
        {
          ...
          final double radius = _getCellRadius(monthView.selectionRadius, centerXPosition, centerYPosition);
          canvas.drawCircle(Offset(xPosition + centerXPosition, yPosition + centerYPosition), radius, monthView._selectionPainter);
        }
        break;
      case DateRangePickerSelectionShape.rectangle:
        {
          canvas.drawRRect(
              RRect.fromRectAndRadius(Rect.fromLTWH(xPosition + 1, yPosition + 1, cellWidth - 1, cellHeight - 1), Radius.circular(cellHeight / 4 > 10 ? 10 : cellHeight / 4)),
...
TextStyle _drawCellAndSelection(
    Canvas canvas, double xPosition, double yPosition, TextStyle selectionTextStyle, TextStyle selectedRangeTextStyle, _IMonthView monthView, int currentIndex) {
  monthView._selectionPainter.color = monthView.selectionColor ?? monthView.datePickerTheme.selectionColor!;
...
void _drawDecoration(Canvas canvas, double xPosition, double yPosition, double padding, double cellWidth, double cellHeight, Decoration dateDecoration, _IMonthView monthView) {
  final BoxPainter boxPainter = dateDecoration.createBoxPainter(monthView.markNeedsPaint);
  boxPainter.paint(canvas, Offset(xPosition + padding, yPosition + padding), ImageConfiguration(size: Size(cellWidth - (2 * padding), cellHeight - (2 * padding))));
}

void _drawCurrentDate(Canvas canvas, _IMonthView monthView, double xPosition, double yPosition, double padding, double cellWidth, double cellHeight) {
  monthView._selectionPainter.color = monthView.todayHighlightColor ?? monthView.datePickerTheme.todayHighlightColor!;
  ...
  switch (monthView.selectionShape) {
    ...
    case DateRangePickerSelectionShape.rectangle:
      {
        canvas.drawRRect(
            RRect.fromRectAndRadius(Rect.fromLTRB(xPosition + padding, yPosition + padding, xPosition + cellWidth - padding, yPosition + cellHeight - padding),
...
TextStyle _updateTextStyle(_IMonthView monthView, bool isNextMonth, bool isPreviousMonth, bool isCurrentDate, bool isEnableDate, bool isBlackedDate, bool isWeekEnd,
    bool isSpecialDate, bool isDisabledDate) {
  final TextStyle currentDatesTextStyle = monthView.cellStyle.textStyle as TextStyle? ?? monthView.datePickerTheme.activeDatesTextStyle!;
  if (isBlackedDate) {
    return monthView.cellStyle.blackoutDateTextStyle as TextStyle? ??
        (monthView.datePickerTheme.blackoutDatesTextStyle ?? currentDatesTextStyle.copyWith(decoration: TextDecoration.lineThrough));
  }

  if (isSpecialDate) {
    final TextStyle? specialDateTextStyle = monthView.cellStyle.specialDatesTextStyle as TextStyle? ?? monthView.datePickerTheme.specialDatesTextStyle;
  ...
  if (!isEnableDate || isDisabledDate) {
    return monthView.cellStyle.disabledDatesTextStyle as TextStyle? ?? monthView.datePickerTheme.disabledDatesTextStyle!;
  }

  if (isCurrentDate) {
    return monthView.cellStyle.todayTextStyle as TextStyle? ?? monthView.datePickerTheme.todayTextStyle!;
  }

  if (isWeekEnd && monthView.cellStyle.weekendTextStyle != null) {
    return monthView.cellStyle.weekendTextStyle as TextStyle;
  } else if (isWeekEnd && monthView.datePickerTheme.weekendDatesTextStyle != null) {
    return monthView.datePickerTheme.weekendDatesTextStyle!;
  }

  if (isNextMonth && !monthView.isHijri) {
    return monthView.cellStyle.leadingDatesTextStyle as TextStyle? ?? monthView.datePickerTheme.leadingDatesTextStyle!;
  } else if (isPreviousMonth && !monthView.isHijri) {
    return monthView.cellStyle.trailingDatesTextStyle as TextStyle? ?? monthView.datePickerTheme.trailingDatesTextStyle!;
  }

  return currentDatesTextStyle;
}

Decoration? _updateDecoration(bool isNextMonth, bool isPreviousMonth, _IMonthView monthView, bool isEnableDate, bool isCurrentDate, bool isBlackedDate, dynamic date,
    bool isWeekEnd, bool isSpecialDate, bool isDisabledDate) {
  final Decoration? dateDecoration = monthView.cellStyle.cellDecoration as Decoration?;
  ...
  if (isSpecialDate && monthView.cellStyle.specialDatesCustomDecoration != null) {
    return monthView.cellStyle.specialDatesCustomDecoration(date) as Decoration;
  }

  if ((!isEnableDate || isDisabledDate) && monthView.cellStyle.disabledDatesDecoration != null) {
  ...
  if (isCurrentDate && monthView.cellStyle.todayCellDecoration != null) {
    return monthView.cellStyle.todayCellDecoration as Decoration? ?? dateDecoration;
  }
  ...
  if (isNextMonth && !monthView.isHijri && monthView.cellStyle.leadingDatesDecoration != null) {
    return monthView.cellStyle.leadingDatesDecoration as Decoration;
  } else if (isPreviousMonth && !monthView.isHijri && monthView.cellStyle.trailingDatesDecoration != null) {
