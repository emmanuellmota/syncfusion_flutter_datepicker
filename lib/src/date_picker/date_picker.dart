...
typedef DateRangePickerViewChangedCallback = void Function(DateRangePickerViewChangedArgs dateRangePickerViewChangedArgs);
...
/// callback.
typedef HijriDatePickerViewChangedCallback = void Function(HijriDatePickerViewChangedArgs hijriDatePickerViewChangedArgs);
...
// parameters.
void _raisePickerViewChangedCallback(_SfDateRangePicker picker, {dynamic visibleDateRange, dynamic view}) {
...
class SfDateRangePicker extends StatelessWidget {
  ...
  SfDateRangePicker(
      ...
      : assert(headerHeight >= -1),
        ...
        initialSelectedRanges = controller != null && controller.selectedRanges != null ? controller.selectedRanges : initialSelectedRanges,
        view = controller != null && controller.view != null ? controller.view! : view,
        initialDisplayDate = controller != null && controller.displayDate != null ? controller.displayDate! : initialDisplayDate ?? DateTime.now(),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<DateRangePickerNavigationDirection>('navigationDirection', navigationDirection));
    ...
    properties.add(IterableDiagnostics<DateTime>(initialSelectedDates).toDiagnosticsNode(name: 'initialSelectedDates'));
    properties.add(DiagnosticsProperty<PickerDateRange>('initialSelectedRange', initialSelectedRange));
    properties.add(IterableDiagnostics<PickerDateRange>(initialSelectedRanges).toDiagnosticsNode(name: 'initialSelectedRanges'));
    ...
    properties.add(DiagnosticsProperty<DateRangePickerViewChangedCallback>('onViewChanged', onViewChanged));
    properties.add(DiagnosticsProperty<DateRangePickerSelectionChangedCallback>('onSelectionChanged', onSelectionChanged));
    ...
    properties.add(DiagnosticsProperty<DateRangePickerSelectableDayPredicate>('selectableDayPredicate', selectableDayPredicate));
    properties.add(EnumProperty<ExtendableRangeSelectionDirection>('extendableRangeSelectionDirection', extendableRangeSelectionDirection));
  }
}
...
class SfHijriDateRangePicker extends StatelessWidget {
  ...
  SfHijriDateRangePicker({
    ...
    this.extendableRangeSelectionDirection = ExtendableRangeSelectionDirection.both,
        ...
        initialSelectedRanges = controller != null && controller.selectedRanges != null ? controller.selectedRanges : initialSelectedRanges,
        view = controller != null && controller.view != null ? controller.view! : view,
        initialDisplayDate = controller != null && controller.displayDate != null ? controller.displayDate! : initialDisplayDate ?? HijriDateTime.now(),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(IterableDiagnostics<HijriDateTime>(initialSelectedDates).toDiagnosticsNode(name: 'initialSelectedDates'));
    properties.add(DiagnosticsProperty<HijriDateRange>('HijriDateRange', initialSelectedRange));
    properties.add(IterableDiagnostics<HijriDateRange>(initialSelectedRanges).toDiagnosticsNode(name: 'initialSelectedRanges'));
    ...
    properties.add(DiagnosticsProperty<HijriDateRangePickerCellBuilder>('cellBuilder', cellBuilder));
    properties.add(DiagnosticsProperty<bool>('allowViewNavigation', allowViewNavigation));
    properties.add(DiagnosticsProperty<bool>('toggleDaySelection', toggleDaySelection));
    properties.add(DiagnosticsProperty<bool>('enablePastDates', enablePastDates));
    properties.add(DiagnosticsProperty<bool>('showNavigationArrow', showNavigationArrow));
    ...
    properties.add(StringProperty('confirmText', confirmText));
    properties.add(DiagnosticsProperty<bool>('enableMultiView', enableMultiView));
    properties.add(DiagnosticsProperty<HijriDatePickerViewChangedCallback>('onViewChanged', onViewChanged));
    properties.add(DiagnosticsProperty<DateRangePickerSelectionChangedCallback>('onSelectionChanged', onSelectionChanged));
    properties.add(DiagnosticsProperty<VoidCallback>('onCancel', onCancel));
    properties.add(DiagnosticsProperty<Function(Object)>('onSubmit', onSubmit));
    ...
    properties.add(DiagnosticsProperty<bool>('showTodayButton', showTodayButton));
    properties.add(DiagnosticsProperty<HijriDatePickerSelectableDayPredicate>('selectableDayPredicate', selectableDayPredicate));
    properties.add(EnumProperty<ExtendableRangeSelectionDirection>('extendableRangeSelectionDirection', extendableRangeSelectionDirection));
  }
}
...
class _SfDateRangePickerState extends State<_SfDateRangePicker> with SingleTickerProviderStateMixin {
  ...
  void didChangeDependencies() {
    ...
    _datePickerTheme = _getPickerThemeData(SfDateRangePickerTheme.of(context), Theme.of(context).colorScheme);
  ...
  void didUpdateWidget(_SfDateRangePicker oldWidget) {
    if (oldWidget.controller != widget.controller) {
      ...
      if (widget.controller != null) {
        ...
        _controller.selectedDates = _getSelectedDates(DateRangePickerHelper.cloneList(widget.controller!.selectedDates));
        _controller.selectedRange = widget.controller!.selectedRange;
        _controller.selectedRanges = _getSelectedRanges(DateRangePickerHelper.cloneList(widget.controller!.selectedRanges));
      ...
      _controller.view ??= widget.isHijri ? DateRangePickerHelper.getHijriPickerView(_view) : DateRangePickerHelper.getPickerView(_view);
      _controller.addPropertyChangedListener(_pickerValueChangedListener);
      _initNavigation();
      _updateSelectionValues();
      _view = DateRangePickerHelper.getPickerView(_controller.view);
    ...
    if (view == DateRangePickerView.month && oldWidget.monthViewSettings.firstDayOfWeek != widget.monthViewSettings.firstDayOfWeek) {
    ...
    if (!widget.isHijri &&
        ...
        oldWidget.monthViewSettings.numberOfWeeksInView != widget.monthViewSettings.numberOfWeeksInView) {
      _initializeScrollView();
    }
    ...
    if (oldWidget.showActionButtons != widget.showActionButtons) {
      if (widget.navigationMode == DateRangePickerNavigationMode.scroll && widget.navigationDirection == DateRangePickerNavigationDirection.vertical) {
        _initializeScrollView();
      }
    ...
    if ((oldWidget.navigationDirection != widget.navigationDirection || oldWidget.enableMultiView != widget.enableMultiView) &&
        widget.navigationMode == DateRangePickerNavigationMode.scroll) {
      _initializeScrollView();
    }
    ...
    if (oldWidget.minDate != widget.minDate || oldWidget.maxDate != widget.maxDate) {
      _currentDate = getValidDate(widget.minDate, widget.maxDate, _currentDate);
      if (widget.navigationMode == DateRangePickerNavigationMode.scroll && !_isScrollViewDatesValid()) {
        _initializeScrollView();
      }
    }

    if (_view == DateRangePickerView.month && oldWidget.navigationDirection != widget.navigationDirection) {
      _viewHeaderVisibleDates.value = _currentViewVisibleDates;
    }

    if (!widget.isHijri &&
        DateRangePickerHelper.getNumberOfWeeksInView(widget.monthViewSettings, widget.isHijri) !=
            DateRangePickerHelper.getNumberOfWeeksInView(oldWidget.monthViewSettings, oldWidget.isHijri)) {
    ...
    if (oldWidget.controller?.displayDate != widget.controller?.displayDate && widget.controller?.displayDate != null) {
      _currentDate = getValidDate(widget.minDate, widget.maxDate, _controller.displayDate);
      _controller.displayDate = _currentDate;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (BuildContext context, BoxConstraints constraints) {
      ...
      _minHeight = constraints.maxHeight == double.infinity ? _minPickerHeight : constraints.maxHeight;
      ...
      final double actionButtonsHeight = (widget.showActionButtons || widget.showTodayButton)
          ? _minHeight! * 0.1 < 50
              ...
              : _minHeight! * 0.1
          : 0;
      _handleScrollViewSizeChanged(_minHeight!, _minWidth!, previousHeight, previousWidth, actionButtonsHeight);

      height = _minHeight! - widget.headerHeight;
      top = widget.headerHeight;
      if (_view == DateRangePickerView.month && widget.navigationDirection == DateRangePickerNavigationDirection.vertical) {
  ...
  SfDateRangePickerThemeData _getPickerThemeData(SfDateRangePickerThemeData pickerTheme, ColorScheme colorScheme) {
    return pickerTheme.copyWith(
        ...
        weekNumberBackgroundColor: pickerTheme.weekNumberBackgroundColor ?? colorScheme.onSurface.withOpacity(0.08),
        viewHeaderTextStyle: pickerTheme.viewHeaderTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 14, fontFamily: 'Roboto'),
        headerTextStyle: pickerTheme.headerTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 16, fontFamily: 'Roboto'),
        trailingDatesTextStyle: pickerTheme.trailingDatesTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.54), fontSize: 13, fontFamily: 'Roboto'),
        leadingCellTextStyle: pickerTheme.leadingCellTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.54), fontSize: 13, fontFamily: 'Roboto'),
        activeDatesTextStyle: pickerTheme.activeDatesTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 13, fontFamily: 'Roboto'),
        cellTextStyle: pickerTheme.cellTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 13, fontFamily: 'Roboto'),
        leadingDatesTextStyle: pickerTheme.leadingDatesTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.54), fontSize: 13, fontFamily: 'Roboto'),
        rangeSelectionTextStyle: pickerTheme.rangeSelectionTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 13, fontFamily: 'Roboto'),
        disabledDatesTextStyle: pickerTheme.disabledDatesTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.38), fontSize: 13, fontFamily: 'Roboto'),
        disabledCellTextStyle: pickerTheme.disabledCellTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.38), fontSize: 13, fontFamily: 'Roboto'),
        selectionTextStyle: pickerTheme.selectionTextStyle ?? TextStyle(color: colorScheme.onPrimary, fontSize: 13, fontFamily: 'Roboto'),
        weekNumberTextStyle: pickerTheme.weekNumberTextStyle ?? TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 13, fontFamily: 'Roboto'),
        todayTextStyle: pickerTheme.todayTextStyle ?? TextStyle(color: colorScheme.primary, fontSize: 13, fontFamily: 'Roboto'),
        todayCellTextStyle: pickerTheme.todayCellTextStyle ??
            // ignore: lines_longer_than_80_chars
            TextStyle(color: colorScheme.primary, fontSize: 13, fontFamily: 'Roboto'),
        ...
        rangeSelectionColor: pickerTheme.rangeSelectionColor ?? colorScheme.primary.withOpacity(0.1),
  ...
  void _initPickerController() {
    _controller = widget.controller ?? (widget.isHijri ? HijriDatePickerController() : DateRangePickerController());
    _controller.selectedDate = widget.initialSelectedDate;
    _controller.selectedDates = _getSelectedDates(DateRangePickerHelper.cloneList(widget.initialSelectedDates));
    ...
    _controller.view = widget.isHijri ? DateRangePickerHelper.getHijriPickerView(widget.view) : DateRangePickerHelper.getPickerView(widget.view);
  ...
  void _pickerValueChangedListener(String value) {
    if (value == 'selectedDate') {
      ...
      if (!mounted || DateRangePickerHelper.isDateCollectionEquals(_selectedDates, _controller.selectedDates)) {
        return;
      }
      ...
      if (!mounted || DateRangePickerHelper.isRangeEquals(_selectedRange, _controller.selectedRange)) {
        return;
      }
      ...
      if (!mounted || DateRangePickerHelper.isDateRangesEquals(_selectedRanges, _controller.selectedRanges)) {
        return;
      }
      ...
      setState(() {
        ...
        if (widget.navigationMode == DateRangePickerNavigationMode.scroll) {
          ...
          _scrollViewKey.currentState!._triggerSelectableDayPredicates(_scrollViewKey.currentState!._currentViewVisibleDates);
      ...
      if (isSameDate(_currentDate, _controller.displayDate) || _checkDateWithInVisibleDates(_controller.displayDate)) {
  ...
  bool _checkDateWithInVisibleDates(dynamic date) {
    ...
    switch (view) {
      case DateRangePickerView.month:
        {
          if (!widget.isHijri && DateRangePickerHelper.getNumberOfWeeksInView(widget.monthViewSettings, widget.isHijri) != 6) {
            return isDateWithInDateRange(_currentViewVisibleDates[0], _currentViewVisibleDates[_currentViewVisibleDates.length - 1], date);
          } else {
            final dynamic currentMonth = _currentViewVisibleDates[_currentViewVisibleDates.length ~/ (_isMultiViewEnabled(widget) ? 4 : 2)];
  ...
  void _updateCurrentVisibleDates() {
    switch (_view) {
      case DateRangePickerView.month:
        {
          _currentViewVisibleDates = getVisibleDates(
            ...
            DateRangePickerHelper.getViewDatesCount(_view, DateRangePickerHelper.getNumberOfWeeksInView(widget.monthViewSettings, widget.isHijri), widget.isHijri),
          );
        }
        break;
      case DateRangePickerView.year:
      ...
      case DateRangePickerView.century:
        {
          _currentViewVisibleDates = DateRangePickerHelper.getVisibleYearDates(_currentDate, _view, widget.isHijri);
        }
    }
  }
  ...
  dynamic _updateCurrentDate(_SfDateRangePicker oldWidget) {
    if (oldWidget.controller == widget.controller &&
      ...
      return _currentViewVisibleDates[_currentViewVisibleDates.length ~/ (_isMultiViewEnabled(widget) ? 4 : 2)];
    }
  ...
  bool _isScrollViewDatesValid() {
    ...
    final DateRangePickerView view = DateRangePickerHelper.getPickerView(_controller.view);
    final int numberOfWeekInView = DateRangePickerHelper.getNumberOfWeeksInView(widget.monthViewSettings, widget.isHijri);
    // ignore: always_specify_types
    final List startDates = _backwardDateCollection.isNotEmpty ? _backwardDateCollection[_backwardDateCollection.length - 1] : _forwardDateCollection[0];
    // ignore: always_specify_types
      ...
      case DateRangePickerView.month:
        {
          if (!widget.isHijri && numberOfWeekInView != 6) {
            final DateTime visibleStartDate = DateRangePickerHelper.getDateTimeValue(startDates[startDates.length - 1]);
            final DateTime visibleEndDate = DateRangePickerHelper.getDateTimeValue(endDates[0]);
            return isDateWithInDateRange(widget.minDate, widget.maxDate, visibleStartDate) && isDateWithInDateRange(widget.minDate, widget.maxDate, visibleEndDate);
          } else {
            final DateTime visibleStartDate = DateRangePickerHelper.getDateTimeValue(startDates[startDates.length ~/ 2]);
            final DateTime visibleEndDate = DateRangePickerHelper.getDateTimeValue(endDates[endDates.length ~/ 2]);
            return (visibleStartDate.year > widget.minDate.year || (visibleStartDate.year == widget.minDate.year && visibleStartDate.month >= widget.minDate.month)) &&
                (visibleStartDate.year < widget.maxDate.year || (visibleStartDate.year == widget.maxDate.year && visibleStartDate.month <= widget.maxDate.month)) &&
                (visibleEndDate.year > widget.minDate.year || (visibleEndDate.year == widget.minDate.year && visibleEndDate.month >= widget.minDate.month)) &&
                (visibleEndDate.year < widget.maxDate.year || (visibleEndDate.year == widget.maxDate.year && visibleEndDate.month <= widget.maxDate.month));
          }
        }
      case DateRangePickerView.year:
        {
  ...
  /// mode.
  void _handleScrollViewSizeChanged(double newHeight, double newWidth, double? oldHeight, double? oldWidth, double actionButtonHeight) {
    if (widget.navigationMode != DateRangePickerNavigationMode.scroll || _pickerScrollController == null || !_pickerScrollController!.hasClients) {
      return;
    }

    if (oldWidth != null && widget.navigationDirection == DateRangePickerNavigationDirection.horizontal && oldWidth != newWidth) {
      ...
      _scrollKey = UniqueKey();
      _pickerKey = UniqueKey();
      _pickerScrollController = ScrollController(initialScrollOffset: index * newWidth)..addListener(_handleScrollChanged);
    } else if (oldHeight != null && widget.navigationDirection == DateRangePickerNavigationDirection.vertical && oldHeight != newHeight) {
      final double viewHeaderHeight = _view == DateRangePickerView.month ? widget.monthViewSettings.viewHeaderHeight as double : 0;
      ...
      _scrollKey = UniqueKey();
      _pickerKey = UniqueKey();
      _pickerScrollController = ScrollController(initialScrollOffset: index * (newHeight - viewHeaderHeight - actionButtonHeight))..addListener(_handleScrollChanged);
    }
  }
  ...
  void _handleScrollChanged() {
    ...
    double widgetSize = widget.navigationDirection == DateRangePickerNavigationDirection.horizontal
        ? _minWidth!
        : _minHeight! - (_view == DateRangePickerView.month ? widget.monthViewSettings.viewHeaderHeight : 0) - actionButtonsHeight;
    ...
    final int numberOfWeeksInView = DateRangePickerHelper.getNumberOfWeeksInView(widget.monthViewSettings, widget.isHijri);
  ...
  void _addScrollViewDateCollection(
      List<dynamic> dateCollection, bool isNextView, dynamic startDate, DateRangePickerView currentView, int numberOfWeeksInView, int visibleDatesCount) {
    int count = 0;
        ...
        case DateRangePickerView.month:
          {
            ...
            if (isNextView) {
              if (!widget.isHijri && numberOfWeeksInView != 6) {
                ...
                final dynamic date = visibleDates[visibleDates.length ~/ 2];
                if ((date.month > widget.maxDate.month == true && date.year == widget.maxDate.year) || date.year > widget.maxDate.year == true) {
                  count = 10;
                  break;
                }
              }
              ...
              if (numberOfWeeksInView != 6 && !widget.isHijri) {
                ...
                final dynamic date = visibleDates[visibleDates.length ~/ 2];
                if ((date.month < widget.minDate.month == true && date.year == widget.minDate.year) || date.year < widget.minDate.year == true) {
                  count = 10;
                  break;
                }
              }
            ...
            if (isNextView) {
              visibleDate = DateRangePickerHelper.getNextViewStartDate(currentView, numberOfWeeksInView, visibleDate, false, widget.isHijri);
            } else {
              visibleDate = DateRangePickerHelper.getPreviousViewStartDate(currentView, numberOfWeeksInView, visibleDate, false, widget.isHijri);
            }
            count++;
          }
          break;
  ...
  Widget _addScrollView(double width, double height, double actionButtonsHeight) {
    ...
    final int numberOfWeeksInView = DateRangePickerHelper.getNumberOfWeeksInView(widget.monthViewSettings, widget.isHijri);
    final int visibleDatesCount = DateRangePickerHelper.getViewDatesCount(currentView, numberOfWeeksInView, widget.isHijri);
    final bool isInitialLoading = _forwardDateCollection.isEmpty;
    if (isInitialLoading) {
      _addScrollViewDateCollection(_forwardDateCollection, true, _currentDate, currentView, numberOfWeeksInView, visibleDatesCount);
    }
    ...
    if (_backwardDateCollection.isEmpty) {
      ...
      dynamic visibleDate = currentView == DateRangePickerView.month && numberOfWeeksInView != 6
          ...
          : lastViewDates != null && lastViewDates.isNotEmpty
              ...
              : _currentDate;
      visibleDate = DateRangePickerHelper.getPreviousViewStartDate(currentView, numberOfWeeksInView, visibleDate, false, widget.isHijri);
      _addScrollViewDateCollection(_backwardDateCollection, false, visibleDate, currentView, numberOfWeeksInView, visibleDatesCount);
    }
    ...
    while (_backwardDateCollection.isNotEmpty && forwardCollectionLength < minForwardCollectionLength) {
    ...
    final bool isHorizontal = widget.navigationDirection == DateRangePickerNavigationDirection.horizontal;
    final double topPosition = _view == DateRangePickerView.month && !isHorizontal ? widget.monthViewSettings.viewHeaderHeight as double : 0.0;
    ...
    if (isHorizontal) {
      ...
      scrollViewItemHeight = widget.enableMultiView ? scrollViewItemHeight / 2 : scrollViewItemHeight;
    }
      ...
      slivers: <Widget>[
        SliverFixedExtentList(
          ...
          delegate: SliverChildBuilderDelegate((BuildContext context, int index) {
            ...
            return _getScrollViewItem(-(index + 1), scrollViewItemWidth, scrollViewItemHeight, _backwardDateCollection[index], isHorizontal);
          }),
        ),
        SliverFixedExtentList(
          itemExtent: isHorizontal ? scrollViewItemWidth : scrollViewItemHeight,
          delegate: SliverChildBuilderDelegate((BuildContext context, int index) {
            ...
            return _getScrollViewItem(index, scrollViewItemWidth, scrollViewItemHeight, _forwardDateCollection[index], isHorizontal);
          }),
          key: _pickerKey,
        ),
      ],
    ...
    if (isHorizontal) {
      ...
      return Stack(children: <Widget>[
        ...
        Positioned(left: 0, top: topPosition, right: 0, height: scrollViewHeight, child: scrollView),
        _getActionsButton(topPosition + scrollViewHeight, actionButtonsHeight)
      ]);
    }
  }
  ...
  Widget _getScrollViewItem(
    ...
    if (index >= 0) {
      if (_forwardDateCollection.isNotEmpty && index > _forwardDateCollection.length - 2) {
        ...
        dynamic date = currentView == DateRangePickerView.month && DateRangePickerHelper.getNumberOfWeeksInView(widget.monthViewSettings, widget.isHijri) != 6
            ? lastViewDates[0]
            : lastViewDates[lastViewDates.length ~/ 2];
        date = DateRangePickerHelper.getNextViewStartDate(currentView, numberOfWeeksInView, date, false, widget.isHijri);
        _addScrollViewDateCollection(_forwardDateCollection, true, date, currentView, numberOfWeeksInView, visibleDatesCount);
      }
    } else {
      if (_backwardDateCollection.isNotEmpty && -index > _backwardDateCollection.length - 2) {
        ...
        dynamic date = currentView == DateRangePickerView.month && DateRangePickerHelper.getNumberOfWeeksInView(widget.monthViewSettings, widget.isHijri) != 6
            ? lastViewDates[0]
            : lastViewDates[lastViewDates.length ~/ 2];
        date = DateRangePickerHelper.getPreviousViewStartDate(currentView, numberOfWeeksInView, date, false, widget.isHijri);
        _addScrollViewDateCollection(_backwardDateCollection, false, date, currentView, numberOfWeeksInView, visibleDatesCount);
      }
    }
    ...
    if (isHorizontal) {
      final String headerText =
          _getHeaderText(dates, _view, 0, widget.isHijri, numberOfWeeksInView, widget.monthFormat, false, widget.headerStyle, widget.navigationDirection, _locale, _localizations);
      headerWidth =
          _getTextWidgetWidth(headerText, widget.headerHeight, pickerWidth, context, style: widget.headerStyle.textStyle ?? _datePickerTheme.headerTextStyle!, widthPadding: 20)
              .width;
    }
    ...
    Color? backgroundColor = widget.headerStyle.backgroundColor ?? _datePickerTheme.headerBackgroundColor;
    if (!isHorizontal && backgroundColor == Colors.transparent) {
      backgroundColor = _datePickerTheme.brightness == Brightness.dark ? Colors.grey[850]! : Colors.white;
    }
      ...
      child: GestureDetector(
        ...
        onTapUp: (TapUpDetails details) {
          ...
          if ((_view == DateRangePickerView.month && _currentDate.year != currentDate.year) ||
              (_view == DateRangePickerView.year && _currentDate.year ~/ 10 != currentDate.year ~/ 10) ||
              (_view == DateRangePickerView.decade && _currentDate.year ~/ 100 != currentDate.year ~/ 100)) {
  ...
  Widget _getActionsButton(double top, double actionButtonsHeight) {
    ...
    if (textColor == Colors.transparent) {
      final TextStyle style = widget.monthCellStyle.todayTextStyle as TextStyle? ?? _datePickerTheme.todayTextStyle!;
                ...
                TextButton(
                  ...
                  onPressed: () {
                    if (widget.allowViewNavigation) {
                      _controller.view = widget.isHijri ? HijriDatePickerView.month : DateRangePickerView.month;
                    }
    ...
    return Positioned(
      ...
      right: 0,
      height: actionButtonsHeight,
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: <Widget>[todayButton, actionButtons]),
    );
  }
  ...
  void _handleCancel() {
    switch (widget.selectionMode) {
      ...
      case DateRangePickerSelectionMode.multiple:
        {
          _selectedDates = _previousSelectedValue.selectedDates != null ? _getSelectedDates(_previousSelectedValue.selectedDates) : null;
          if (!DateRangePickerHelper.isDateCollectionEquals(_selectedDates, _controller.selectedDates)) {
            setState(() {
              _controller.selectedDates = _previousSelectedValue.selectedDates != null ? _getSelectedDates(_previousSelectedValue.selectedDates) : null;
            });
          }
        }
        break;
      ...
      case DateRangePickerSelectionMode.multiRange:
        {
          _selectedRanges = _previousSelectedValue.selectedRanges != null ? _getSelectedRanges(_previousSelectedValue.selectedRanges) : null;
          if (!DateRangePickerHelper.isDateRangesEquals(_selectedRanges, _controller.selectedRanges)) {
            setState(() {
              _controller.selectedRanges = _previousSelectedValue.selectedRanges != null ? _getSelectedRanges(_previousSelectedValue.selectedRanges) : null;
            });
          }
        }
    }
  ...
  Widget _getViewHeaderView(double topPosition) {
    if (_view == DateRangePickerView.month && widget.navigationDirection == DateRangePickerNavigationDirection.vertical) {
      final Color todayTextColor = widget.monthCellStyle.todayTextStyle != null && widget.monthCellStyle.todayTextStyle!.color != null
          ? widget.monthCellStyle.todayTextStyle!.color! as Color
          : (widget.todayHighlightColor != null && widget.todayHighlightColor! != Colors.transparent ? widget.todayHighlightColor! : _datePickerTheme.todayHighlightColor!);
      return Positioned(
        left: 0,
        top: topPosition,
        right: 0,
        ...
        child: _AnimatedOpacityWidget(
          opacity: _opacity,
          child: Container(
            color: widget.monthViewSettings.viewHeaderStyle.backgroundColor ?? _datePickerTheme.viewHeaderBackgroundColor,
  ...
  void _moveToNextView() {
    ...
    if (!DateRangePickerHelper.canMoveToNextView(_view, DateRangePickerHelper.getNumberOfWeeksInView(widget.monthViewSettings, widget.isHijri), widget.maxDate,
        _currentViewVisibleDates, _isMultiViewEnabled(widget), widget.isHijri)) {
      return;
    }

    _isRtl ? _scrollViewKey.currentState!._moveToPreviousViewWithAnimation() : _scrollViewKey.currentState!._moveToNextViewWithAnimation();
  }
  ...
  void _moveToPreviousView() {
    ...
    if (!DateRangePickerHelper.canMoveToPreviousView(_view, DateRangePickerHelper.getNumberOfWeeksInView(widget.monthViewSettings, widget.isHijri), widget.minDate,
        _currentViewVisibleDates, _isMultiViewEnabled(widget), widget.isHijri)) {
      return;
    }

    _isRtl ? _scrollViewKey.currentState!._moveToNextViewWithAnimation() : _scrollViewKey.currentState!._moveToPreviousViewWithAnimation();
  }
  ...
  void _updatePickerStateValues(PickerStateArgs details) {
    ...
    if (_view != details.view) {
      _controller.view = widget.isHijri ? DateRangePickerHelper.getHijriPickerView(details.view) : DateRangePickerHelper.getPickerView(details.view);
      if (_view == DateRangePickerView.month && widget.navigationDirection == DateRangePickerNavigationDirection.vertical) {
        _viewHeaderVisibleDates.value = _currentViewVisibleDates;
      }
    }
    ...
    if (_view == DateRangePickerView.month && widget.navigationDirection == DateRangePickerNavigationDirection.vertical) {
      ...
      if ((_currentDate.month == today.month && _currentDate.year == today.year) ||
          (_currentDate.month == previousMonthDate.month && _currentDate.year == previousMonthDate.year) ||
        ...
        case DateRangePickerSelectionMode.single:
          {
            ...
            if (widget.navigationMode == DateRangePickerNavigationMode.scroll && !isSameSelectedDate) {
              setState(() {
        ...
        case DateRangePickerSelectionMode.multiple:
          {
            ...
            final bool isSameSelectedDate = DateRangePickerHelper.isDateCollectionEquals(_selectedDates, _controller.selectedDates);
            if (widget.navigationMode == DateRangePickerNavigationMode.scroll && !isSameSelectedDate) {
              setState(() {
                /// Update selection views for scroll navigation mode.
              });
            ...
            if (!isSameSelectedDate) _raiseSelectionChangedCallback(widget, value: _controller.selectedDates);
          }
          break;
        case DateRangePickerSelectionMode.range:
        case DateRangePickerSelectionMode.extendableRange:
          {
            ...
            final bool isSameSelectedDate = DateRangePickerHelper.isRangeEquals(_selectedRange, _controller.selectedRange);
            if (widget.navigationMode == DateRangePickerNavigationMode.scroll && !isSameSelectedDate) {
              setState(() {
                /// Update selection views for scroll navigation mode.
              });
            ...
            _controller.selectedRange = _selectedRange;
            if (!isSameSelectedDate) _raiseSelectionChangedCallback(widget, value: _controller.selectedRange);
          }
          break;
        case DateRangePickerSelectionMode.multiRange:
          {
            _selectedRanges = details.selectedRanges;
            final bool isSameSelectedDate = DateRangePickerHelper.isDateRangesEquals(_selectedRanges, _controller.selectedRanges);
            if (widget.navigationMode == DateRangePickerNavigationMode.scroll && !isSameSelectedDate) {
              setState(() {
                /// Update selection views for scroll navigation mode.
              });
            ...
            if (!isSameSelectedDate) _raiseSelectionChangedCallback(widget, value: _controller.selectedRanges);
          }
      }
    }
  }
      ...
      case DateRangePickerView.month:
        {
          ...
          if (widget.isHijri ||
              (!DateRangePickerHelper.canShowLeadingAndTrailingDates(widget.monthViewSettings, widget.isHijri) &&
                  DateRangePickerHelper.getNumberOfWeeksInView(widget.monthViewSettings, widget.isHijri) == 6)) {
            final dynamic visibleDate = _currentViewVisibleDates[_currentViewVisibleDates.length ~/ (enableMultiView ? 4 : 2)];
            if (widget.isHijri) {
              visibleDateRange = HijriDateRange(
                  ...
                  enableMultiView
                      ? DateRangePickerHelper.getMonthEndDate(
                          DateRangePickerHelper.getNextViewStartDate(DateRangePickerHelper.getPickerView(_controller.view), 6, visibleDate, _isRtl, widget.isHijri))
            ...
            _raisePickerViewChangedCallback(widget, visibleDateRange: visibleDateRange, view: _controller.view);
          } else {
            if (widget.isHijri) {
              visibleDateRange = HijriDateRange(_currentViewVisibleDates[0], _currentViewVisibleDates[_currentViewVisibleDates.length - 1]);
            } else {
              visibleDateRange = PickerDateRange(_currentViewVisibleDates[0], _currentViewVisibleDates[_currentViewVisibleDates.length - 1]);
            }
            _raisePickerViewChangedCallback(widget, visibleDateRange: visibleDateRange, view: _controller.view);
          }
        }
  ...
  void _updateCalendarTapCallbackForHeader() {
    ...
    if (_view == DateRangePickerView.month) {
      _controller.view = widget.isHijri ? DateRangePickerHelper.getHijriPickerView(DateRangePickerView.year) : DateRangePickerHelper.getPickerView(DateRangePickerView.year);
    } else {
      if (_view == DateRangePickerView.year) {
        _controller.view = widget.isHijri ? DateRangePickerHelper.getHijriPickerView(DateRangePickerView.decade) : DateRangePickerHelper.getPickerView(DateRangePickerView.decade);
      } else if (_view == DateRangePickerView.decade) {
        _controller.view =
            widget.isHijri ? DateRangePickerHelper.getHijriPickerView(DateRangePickerView.century) : DateRangePickerHelper.getPickerView(DateRangePickerView.century);
      }
    }
  }
}
...
class _StickyHeaderRenderObject extends RenderStack {
  ...
  void updateHeaderOffset() {
    ...
    final double currentViewOffset = viewPosition - _scrollableState.position.pixels - _scrollableSize;
    ...
    final double headerYOffset =
        _isRTL && _isHorizontal ? contentSize - headerSize - _getHeaderOffset(contentSize, offset, headerSize) : _getHeaderOffset(contentSize, offset, headerSize);
...
class _PickerHeaderViewState extends State<_PickerHeaderView> {
  ...
  Widget build(BuildContext context) {
    ...
    showNavigationArrow = showNavigationArrow && widget.navigationMode != DateRangePickerNavigationMode.scroll;
    ...
    Color arrowColor = widget.headerStyle.textStyle != null && widget.headerStyle.textStyle!.color != null
    ...
    if (showNavigationArrow && !DateRangePickerHelper.canMoveToNextView(widget.view, widget.numberOfWeeksInView, widget.maxDate, dates, widget.enableMultiView, widget.isHijri)) {
      nextArrowColor = nextArrowColor.withOpacity(arrowColor.opacity * 0.5);
    }

    if (showNavigationArrow &&
        !DateRangePickerHelper.canMoveToPreviousView(widget.view, widget.numberOfWeeksInView, widget.minDate, dates, widget.enableMultiView, widget.isHijri)) {
    ...
    if (widget.navigationMode == DateRangePickerNavigationMode.scroll && widget.navigationDirection == DateRangePickerNavigationDirection.horizontal) {
      return headerText;
    }
    ...
    final Container leftArrow = _getLeftArrow(arrowWidth, arrowColor, prevArrowColor, arrowSize);

    final Container rightArrow = _getRightArrow(arrowWidth, arrowColor, nextArrowColor, arrowSize);
  ...
  Widget _getHeaderText(double headerWidth, bool isMobilePlatform) {
    return MouseRegion(
        onEnter: (PointerEnterEvent event) {
          if (widget.view == DateRangePickerView.century || (widget.isHijri && widget.view == DateRangePickerView.decade) || isMobilePlatform) {
            return;
          }
  ...
  Container _getLeftArrow(double arrowWidth, Color arrowColor, Color prevArrowColor, double arrowSize) {
    return Container(
      alignment: Alignment.center,
      ...
      child: MaterialButton(
        ...
        child: Semantics(
          label: 'Backward',
          child: Icon(
            widget.navigationDirection == DateRangePickerNavigationDirection.horizontal ? Icons.chevron_left : Icons.keyboard_arrow_up,
  ...
  Container _getRightArrow(double arrowWidth, Color arrowColor, Color nextArrowColor, double arrowSize) {
    return Container(
      alignment: Alignment.center,
      color: widget.headerStyle.backgroundColor ?? widget.datePickerTheme.headerBackgroundColor,
      width: arrowWidth,
      ...
      child: MaterialButton(
        ...
        child: Semantics(
          label: 'Forward',
          child: Icon(
            widget.navigationDirection == DateRangePickerNavigationDirection.horizontal ? Icons.chevron_right : Icons.keyboard_arrow_down,
...
class _PickerHeaderPainter extends CustomPainter {
  _PickerHeaderPainter(this.visibleDates, this.headerStyle, this.view, this.numberOfWeeksInView, this.monthFormat, this.datePickerTheme, this.isRtl, this.locale,
      this.enableMultiView, this.multiViewSpacing, this.hoverColor, this.hovering, this.textScaleFactor, this.isHijri, this.localizations, this.navigationDirection)
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _headerText = '';
    final double width = (enableMultiView && navigationDirection == DateRangePickerNavigationDirection.horizontal) && headerStyle.textAlign == TextAlign.center
        ? (size.width - multiViewSpacing) / 2
        : size.width;
    final int count = (enableMultiView && navigationDirection == DateRangePickerNavigationDirection.horizontal) && headerStyle.textAlign == TextAlign.center ? 2 : 1;
    for (int j = 0; j < count; j++) {
      final int currentViewIndex = isRtl ? DateRangePickerHelper.getRtlIndex(count, j) : j;
      xPosition = (currentViewIndex * width) + 10;

      final String text =
          _getHeaderText(visibleDates.value, view, j, isHijri, numberOfWeeksInView, monthFormat, enableMultiView, headerStyle, navigationDirection, locale, localizations);
      _headerText += j == 1 ? ' $text' : text;
      TextStyle? style = headerStyle.textStyle ?? datePickerTheme.headerTextStyle;
      if (hovering) {
      ...
      if (headerStyle.textAlign == TextAlign.center) {
        xPosition = (currentViewIndex * width) + (currentViewIndex * multiViewSpacing) + (width / 2) - (_textPainter.width / 2);
      } else if ((!isRtl && (headerStyle.textAlign == TextAlign.right || headerStyle.textAlign == TextAlign.end)) ||
          (isRtl && (headerStyle.textAlign == TextAlign.left || headerStyle.textAlign == TextAlign.start))) {
...
class _PickerViewHeaderPainter extends CustomPainter {
  ...
  final DateRangePickerNavigationDirection navigationDirection;
  final TextPainter _textPainter = TextPainter(textDirection: TextDirection.ltr, textAlign: TextAlign.left, textWidthBasis: TextWidthBasis.longestLine);
  ...
  void paint(Canvas canvas, Size size) {
    canvas.clipRect(Rect.fromLTWH(0, 0, size.width, size.height));
    final double weekNumberPanelWidth = DateRangePickerHelper.getWeekNumberPanelWidth(showWeekNumber, size.width, isMobilePlatform);
    double width = showWeekNumber ? (size.width - weekNumberPanelWidth) / DateTime.daysPerWeek : size.width / DateTime.daysPerWeek;
    if (enableMultiView && navigationDirection == DateRangePickerNavigationDirection.horizontal) {
      width =
          showWeekNumber ? (size.width - multiViewSpacing - (weekNumberPanelWidth * 2)) / (DateTime.daysPerWeek * 2) : (size.width - multiViewSpacing) / (DateTime.daysPerWeek * 2);
    }

    /// Initializes the default text style for the texts in view header of
    /// picker.
    final TextStyle? viewHeaderDayStyle = viewHeaderStyle.textStyle ?? datePickerTheme.viewHeaderTextStyle;
    ...
    double yPosition = 0;
    final int count = (enableMultiView && navigationDirection == DateRangePickerNavigationDirection.horizontal) ? 2 : 1;
    final int datesCount = (enableMultiView && navigationDirection == DateRangePickerNavigationDirection.horizontal) ? visibleDates.length ~/ 2 : visibleDates.length;
    final bool isVerticalScroll = navigationDirection == DateRangePickerNavigationDirection.vertical && navigationMode == DateRangePickerNavigationMode.scroll;
    visibleDates = viewHeaderVisibleDates != null ? viewHeaderVisibleDates!.value : visibleDates;

    for (int j = 0; j < count; j++) {
      final int currentViewIndex = isRtl ? DateRangePickerHelper.getRtlIndex(count, j) : j;
      dynamic currentDate;
      final int month = visibleDates[(currentViewIndex * datesCount) + (datesCount ~/ 2)].month as int;
      final int year = visibleDates[(currentViewIndex * datesCount) + (datesCount ~/ 2)].year as int;
      final int currentMonth = today.month as int;
      final int currentYear = today.year as int;

      final int numberOfWeeksInView = DateRangePickerHelper.getNumberOfWeeksInView(monthViewSettings, isHijri);
      final bool isTodayMonth = isDateWithInDateRange(visibleDates[(currentViewIndex * datesCount)], visibleDates[((currentViewIndex + 1) * datesCount) - 1], today);
      final bool hasToday = isVerticalScroll || (numberOfWeeksInView > 0 && numberOfWeeksInView < 6 || month == currentMonth && year == currentYear);
      for (int i = 0; i < DateTime.daysPerWeek; i++) {
        ...
        String dayText = monthViewSettings.dayFormatBuilder != null
            ? monthViewSettings.dayFormatBuilder(isHijri ? currentDate.toDateTime().weekday : currentDate.weekday) as String
            : DateFormat(monthViewSettings.dayFormat, locale.toString()).format(isHijri ? currentDate.toDateTime() : currentDate).toUpperCase();
        dayText = _updateViewHeaderFormat(dayText, monthViewSettings.dayFormatBuilder != null);

        if (hasToday && currentDate.weekday == today.weekday && (isTodayMonth || isVerticalScroll)) {
          final Color textColor = monthCellStyle.todayTextStyle != null && monthCellStyle.todayTextStyle.color != null
        ...
        final TextSpan dayTextSpan = TextSpan(
          text: dayText,
          style: dayTextStyle?.copyWith(color: monthViewSettings.weekendDaysColor),
        );
        ...
        _textPainter.paint(canvas, Offset(xPosition + (width / 2 - _textPainter.width / 2), yPosition));
        xPosition += width;
      }
  ...
  String _updateViewHeaderFormat(String dayText, bool isCustom) {
    ...
    if (!isCustom && monthViewSettings.dayFormat == 'EE' && locale.languageCode == 'en') {
      dayText = dayText[0];
    }
    ...
    for (int j = 0; j < count; j++) {
      for (int i = 0; i < DateTime.daysPerWeek; i++) {
        semanticsBuilder.add(CustomPainterSemantics(
          ...
          properties: SemanticsProperties(
            label: DateFormat('EEEEE').format(isHijri ? visibleDates[(j * datesCount) + i].toDateTime() : visibleDates[(j * datesCount) + i]).toUpperCase(),
            textDirection: TextDirection.ltr,
          ),
        ));
        if (isRtl) {
...
class _PickerScrollViewState extends State<_PickerScrollView> with TickerProviderStateMixin {
  ...
  late List<dynamic> _visibleDates, _previousViewVisibleDates, _nextViewVisibleDates, _currentViewVisibleDates;

  /// keys maintained to access the data and methods from the picker view
  /// class.
  final GlobalKey<_PickerViewState> _previousViewKey = GlobalKey<_PickerViewState>(), _currentViewKey = GlobalKey<_PickerViewState>(), _nextViewKey = GlobalKey<_PickerViewState>();
  ...
  void didUpdateWidget(_PickerScrollView oldWidget) {
    if (widget.picker.navigationDirection != oldWidget.picker.navigationDirection ||
        ...
        widget.picker.extendableRangeSelectionDirection != oldWidget.picker.extendableRangeSelectionDirection) {
      _position = 0;
      _children.clear();
    }

    if (oldWidget.textScaleFactor != widget.textScaleFactor || oldWidget.picker.isHijri != widget.picker.isHijri) {
      _position = 0;
      _children.clear();
    }
    ...
    if (widget.isRtl != oldWidget.isRtl || widget.picker.enableMultiView != oldWidget.picker.enableMultiView) {
      _position = 0;
      _children.clear();
      _updateVisibleDates();
      _triggerSelectableDayPredicates(_currentViewVisibleDates);
    ...
    if (pickerView == DateRangePickerView.year && widget.picker.monthFormat != oldWidget.picker.monthFormat) {
      _position = 0;
      _children.clear();
    }

    if (pickerView != DateRangePickerView.month && widget.picker.yearCellStyle != oldWidget.picker.yearCellStyle) {
      _position = 0;
      _children.clear();
    }

    if (widget.picker.minDate != oldWidget.picker.minDate || widget.picker.maxDate != oldWidget.picker.maxDate) {
    ...
    if (pickerView == DateRangePickerView.month &&
        (oldWidget.picker.monthViewSettings.viewHeaderStyle != widget.picker.monthViewSettings.viewHeaderStyle ||
            oldWidget.picker.monthViewSettings.viewHeaderHeight != widget.picker.monthViewSettings.viewHeaderHeight ||
            DateRangePickerHelper.canShowLeadingAndTrailingDates(widget.picker.monthViewSettings, widget.picker.isHijri) !=
                DateRangePickerHelper.canShowLeadingAndTrailingDates(oldWidget.picker.monthViewSettings, oldWidget.picker.isHijri))) {
      _children.clear();
      _position = 0;

      if (DateRangePickerHelper.canShowLeadingAndTrailingDates(widget.picker.monthViewSettings, widget.picker.isHijri) !=
          DateRangePickerHelper.canShowLeadingAndTrailingDates(oldWidget.picker.monthViewSettings, oldWidget.picker.isHijri)) {
    ...
    if (DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri) !=
            DateRangePickerHelper.getNumberOfWeeksInView(oldWidget.picker.monthViewSettings, oldWidget.picker.isHijri) ||
        widget.picker.monthViewSettings.firstDayOfWeek != oldWidget.picker.monthViewSettings.firstDayOfWeek) {
      _updateVisibleDates();
      _position = 0;
      _triggerSelectableDayPredicates(_currentViewVisibleDates);
      _triggerViewChangedCallback();
    ...
    if (oldWidget.picker.allowViewNavigation != widget.picker.allowViewNavigation && pickerView != DateRangePickerView.month) {
      _position = 0;
      _children.clear();
      _triggerSelectableDayPredicates(_currentViewVisibleDates);
    }

    if (oldWidget.picker.controller != widget.controller || widget.controller == null) {
      widget.getPickerStateValues(_pickerStateDetails);
      super.didUpdateWidget(oldWidget);
      return;
    }

    if (oldWidget.picker.controller?.displayDate != widget.controller?.displayDate || !isSameDate(_pickerStateDetails.currentDate, widget.controller.displayDate)) {
          ...
          child: GestureDetector(
            child: FocusScope(
              ...
              child: CustomScrollViewerLayout(
                  _addViews(context),
                  widget.picker.navigationDirection == DateRangePickerNavigationDirection.horizontal ? CustomScrollDirection.horizontal : CustomScrollDirection.vertical,
                  _position,
                  _currentChildIndex),
            ),
            onHorizontalDragStart:
                widget.picker.navigationDirection == DateRangePickerNavigationDirection.horizontal && widget.picker.navigationMode != DateRangePickerNavigationMode.none
                    ? _onHorizontalStart
                    : null,
            ...
            onHorizontalDragEnd:
                widget.picker.navigationDirection == DateRangePickerNavigationDirection.horizontal && widget.picker.navigationMode != DateRangePickerNavigationMode.none
                    ...
                    : null,
            onVerticalDragStart:
                widget.picker.navigationDirection == DateRangePickerNavigationDirection.vertical && widget.picker.navigationMode != DateRangePickerNavigationMode.none
                    ? _onVerticalStart
                    : null,
  ...
  void _updateVisibleDates() {
    widget.getPickerStateValues(_pickerStateDetails);
    final int numberOfWeeksInView = DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri);
    ...
    final dynamic prevDate = DateRangePickerHelper.getPreviousViewStartDate(
        DateRangePickerHelper.getPickerView(widget.controller.view), numberOfWeeksInView, _pickerStateDetails.currentDate, widget.isRtl, widget.picker.isHijri);
    ...
    if (widget.picker.enableMultiView) {
      afterNextViewDate = DateRangePickerHelper.getNextViewStartDate(
          DateRangePickerHelper.getPickerView(widget.controller.view), numberOfWeeksInView, widget.isRtl ? prevDate : nextDate, false, widget.picker.isHijri);
    }
    ...
    switch (view) {
      case DateRangePickerView.month:
        {
          _visibleDates = getVisibleDates(
            ...
            DateRangePickerHelper.getViewDatesCount(view, numberOfWeeksInView, widget.picker.isHijri),
          );
      ...
      case DateRangePickerView.century:
        {
          _visibleDates = DateRangePickerHelper.getVisibleYearDates(currentDate, view, widget.picker.isHijri);
          _previousViewVisibleDates = DateRangePickerHelper.getVisibleYearDates(prevDate, view, widget.picker.isHijri);
          _nextViewVisibleDates = DateRangePickerHelper.getVisibleYearDates(nextDate, view, widget.picker.isHijri);
          if (widget.picker.enableMultiView) {
            afterVisibleDates = DateRangePickerHelper.getVisibleYearDates(afterNextViewDate, view, widget.picker.isHijri);
          }
        }
    }
  ...
  void _updateNextViewVisibleDates() {
    ...
    if ((pickerView == DateRangePickerView.month && (numberOfWeeksInView == 6 || widget.picker.isHijri)) ||
        pickerView == DateRangePickerView.year ||
        pickerView == DateRangePickerView.decade ||
        pickerView == DateRangePickerView.century) {
      currentViewDate = _currentViewVisibleDates[(_currentViewVisibleDates.length / (widget.picker.enableMultiView ? 4 : 2)).truncate()];
    }

    final DateRangePickerView view = DateRangePickerHelper.getPickerView(widget.controller.view);

    currentViewDate = DateRangePickerHelper.getNextViewStartDate(view, numberOfWeeksInView, currentViewDate, widget.isRtl, widget.picker.isHijri);
    List<dynamic>? afterVisibleDates;
    dynamic afterNextViewDate;
    if (widget.picker.enableMultiView && !widget.isRtl) {
      afterNextViewDate = DateRangePickerHelper.getNextViewStartDate(view, numberOfWeeksInView, currentViewDate, widget.isRtl, widget.picker.isHijri);
    }
    List<dynamic> dates;
    switch (view) {
      case DateRangePickerView.month:
      ...
      case DateRangePickerView.century:
        {
          dates = DateRangePickerHelper.getVisibleYearDates(currentViewDate, view, widget.picker.isHijri);
          if (widget.picker.enableMultiView && !widget.isRtl) {
            afterVisibleDates = DateRangePickerHelper.getVisibleYearDates(afterNextViewDate, view, widget.picker.isHijri);
          }
        }
  ...
  void _updatePreviousViewVisibleDates() {
    ...
    currentViewDate = DateRangePickerHelper.getPreviousViewStartDate(view, numberOfWeeksInView, currentViewDate, widget.isRtl, widget.picker.isHijri);
    List<dynamic> dates;
    List<dynamic>? afterVisibleDates;
    dynamic afterNextViewDate;
    if (widget.picker.enableMultiView && widget.isRtl) {
      afterNextViewDate = DateRangePickerHelper.getPreviousViewStartDate(view, numberOfWeeksInView, currentViewDate, widget.isRtl, widget.picker.isHijri);
    }
  ...
  _PickerView _getView(List<dynamic> dates, Key key) {
    return _PickerView(
      ...
      _focusNode,
      widget.textScaleFactor,
      DateRangePickerHelper.cloneList((_disabledDates != null && _disabledDates?.values != null && _disabledDates!.values.isNotEmpty) ? _disabledDates?.values.first : null),
      key: key,
  ...
  List<Widget> _addViews(BuildContext context) {
    ...
    final _PickerView previousView = _updateViews(_previousView!, _previousView!.visibleDates, _previousViewVisibleDates);
    final _PickerView currentView = _updateViews(_currentView!, _currentView!.visibleDates, _visibleDates);
    final _PickerView nextView = _updateViews(_nextView!, _nextView!.visibleDates, _nextViewVisibleDates);
  ...
  _PickerView _updateViews(_PickerView view, List<dynamic> viewDates, List<dynamic> visibleDates) {
    ...
    if (viewDates != visibleDates) {
      ...
      _children[index] = view;
        ...
        !DateRangePickerHelper.isDateCollectionEquals(view.disableDatePredicates, _disabledDates!.values.first)) {
  ...
  void _updateSettings(_PickerScrollView oldWidget) {
    ...
    if (oldWidget.picker.monthViewSettings != widget.picker.monthViewSettings ||
        ...
        oldWidget.picker.monthViewSettings.blackoutDates != widget.picker.monthViewSettings.blackoutDates ||
        oldWidget.picker.monthViewSettings.specialDates != widget.picker.monthViewSettings.specialDates ||
        oldWidget.picker.monthViewSettings.weekendDays != widget.picker.monthViewSettings.weekendDays ||
  ...
  void _drawSelection(dynamic oldValue, dynamic newValue) {
    ...
    switch (widget.picker.selectionMode) {
      case DateRangePickerSelectionMode.single:
        {
          if (oldValue.selectedDate != newValue.selectedDate || !isSameDate(_pickerStateDetails.selectedDate, newValue.selectedDate)) {
      ...
      case DateRangePickerSelectionMode.multiple:
        {
          if (oldValue.selectedDates != newValue.selectedDates || !DateRangePickerHelper.isDateCollectionEquals(_pickerStateDetails.selectedDates, newValue.selectedDates)) {
      ...
      case DateRangePickerSelectionMode.extendableRange:
        {
          if (oldValue.selectedRange != newValue.selectedRange || !DateRangePickerHelper.isRangeEquals(_pickerStateDetails.selectedRange, newValue.selectedRange)) {
      ...
      case DateRangePickerSelectionMode.multiRange:
        {
          if (oldValue.selectedRanges != newValue.selectedRanges || !DateRangePickerHelper.isDateRangesEquals(_pickerStateDetails.selectedRanges, newValue.selectedRanges)) {
  ...
  void _updateSelection({dynamic selectedDate}) {
    ...
    for (int i = 0; i < _children.length; i++) {
      ...
      switch (view) {
        case DateRangePickerView.month:
          {
            viewState._monthView!.selectionNotifier.value = !viewState._monthView!.selectionNotifier.value;
          }
          break;
        case DateRangePickerView.year:
        case DateRangePickerView.decade:
      ...
      if (widget.picker.selectionMode == DateRangePickerSelectionMode.range || widget.picker.selectionMode == DateRangePickerSelectionMode.extendableRange) {
  ...
  void _updateCurrentViewVisibleDates({bool isNextView = false}) {
    ...
    final int numberOfWeeksInView = DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri);
    if (pickerView == DateRangePickerView.month && (numberOfWeeksInView == 6 || widget.picker.isHijri)) {
      final dynamic date = _currentViewVisibleDates[_currentViewVisibleDates.length ~/ (widget.picker.enableMultiView ? 4 : 2)];
      _pickerStateDetails.currentDate = DateRangePickerHelper.getDate(date.year, date.month, 1, widget.picker.isHijri);
    }
  ...
  dynamic _getYearSelectedDate(dynamic selectedDate, LogicalKeyboardKey key, _PickerView view, _PickerViewState state) {
    final DateRangePickerView pickerView = DateRangePickerHelper.getPickerView(widget.controller.view);
    dynamic date;

    /// Calculate the index value for previous selected date.
    int index = DateRangePickerHelper.getDateCellIndex(view.visibleDates, selectedDate, widget.controller.view);
    if (key == LogicalKeyboardKey.arrowRight) {
      ...
      /// action.
      if ((index == view.visibleDates.length - 1 || (widget.picker.enableMultiView && pickerView != DateRangePickerView.year && index >= view.visibleDates.length - 3)) &&
      ...
      if (index <= 8 && index != -1) {
        index += 3;
        date = view.visibleDates[index];
      } else if (widget.picker.enableMultiView && widget.picker.navigationDirection == DateRangePickerNavigationDirection.vertical && index <= 20 && index != -1) {
        index += 3;
        date = _updateNextYearSelectionDate(selectedDate);
        for (int i = 1; i < 3; i++) {
  ...
  dynamic _updateNextYearSelectionDate(dynamic selectedDate) {
    ...
    switch (view) {
      ...
      case DateRangePickerView.year:
        {
          return DateRangePickerHelper.getNextViewStartDate(DateRangePickerView.month, numberOfWeeksInView, selectedDate, widget.isRtl, widget.picker.isHijri);
        }
      case DateRangePickerView.decade:
        {
          return DateRangePickerHelper.getNextViewStartDate(DateRangePickerView.year, numberOfWeeksInView, selectedDate, widget.isRtl, widget.picker.isHijri);
        }
      case DateRangePickerView.century:
        {
          return DateRangePickerHelper.getNextViewStartDate(DateRangePickerView.decade, numberOfWeeksInView, selectedDate, widget.isRtl, widget.picker.isHijri);
        }
    }
  ...
  dynamic _updatePreviousYearSelectionDate(dynamic selectedDate) {
    ...
    switch (view) {
      ...
      case DateRangePickerView.year:
        {
          return DateRangePickerHelper.getPreviousViewStartDate(DateRangePickerView.month, numberOfWeeksInView, selectedDate, widget.isRtl, widget.picker.isHijri);
        }
      case DateRangePickerView.decade:
        {
          return DateRangePickerHelper.getPreviousViewStartDate(DateRangePickerView.year, numberOfWeeksInView, selectedDate, widget.isRtl, widget.picker.isHijri);
        }
      case DateRangePickerView.century:
        {
          return DateRangePickerHelper.getPreviousViewStartDate(DateRangePickerView.decade, numberOfWeeksInView, selectedDate, widget.isRtl, widget.picker.isHijri);
        }
    }
  ...
  KeyEventResult _updateYearSelectionByKeyBoardNavigation(
      _PickerViewState currentVisibleViewState, _PickerView currentVisibleView, DateRangePickerView pickerView, RawKeyEvent event) {
    dynamic selectedDate;
    if (_pickerStateDetails.selectedDate != null && widget.picker.selectionMode == DateRangePickerSelectionMode.single) {
      selectedDate = _getYearSelectedDate(_pickerStateDetails.selectedDate, event.logicalKey, currentVisibleView, currentVisibleViewState);
      if (selectedDate != null &&
          DateRangePickerHelper.isBetweenMinMaxDateCell(
              selectedDate, widget.picker.minDate, widget.picker.maxDate, widget.picker.enablePastDates, widget.controller.view, widget.picker.isHijri)) {
      ...
      final dynamic date = _pickerStateDetails.selectedDates![_pickerStateDetails.selectedDates!.length - 1];
      selectedDate = _getYearSelectedDate(date, event.logicalKey, currentVisibleView, currentVisibleViewState);
      if (selectedDate != null &&
          DateRangePickerHelper.isBetweenMinMaxDateCell(
              selectedDate, widget.picker.minDate, widget.picker.maxDate, widget.picker.enablePastDates, widget.controller.view, widget.picker.isHijri)) {
        _pickerStateDetails.selectedDates = DateRangePickerHelper.cloneList(_pickerStateDetails.selectedDates)?..add(selectedDate);
      }
    } else if ((widget.picker.selectionMode == DateRangePickerSelectionMode.range || widget.picker.selectionMode == DateRangePickerSelectionMode.extendableRange) &&
      ...
      final bool isExtendableRange = widget.picker.selectionMode == DateRangePickerSelectionMode.extendableRange;
      ...
      if (isExtendableRange &&
          DateRangePickerHelper.isDisableDirectionDate(
              _pickerStateDetails.selectedRange, selectedDate, widget.picker.extendableRangeSelectionDirection, pickerView, widget.picker.isHijri)) {
        return KeyEventResult.ignored;
      }
      ...
      if (selectedDate.isAfter(endDate) == true) {
        ...
        if (isExtendableRange && widget.picker.extendableRangeSelectionDirection != ExtendableRangeSelectionDirection.both) {
          if (widget.picker.extendableRangeSelectionDirection == ExtendableRangeSelectionDirection.forward) {
            endDate = selectedDate;
          } else if (widget.picker.extendableRangeSelectionDirection == ExtendableRangeSelectionDirection.backward) {
            startDate = selectedDate;
          }
        } else {
      ...
      endDate = DateRangePickerHelper.getLastDate(endDate, widget.controller.view, widget.picker.isHijri);
      ...
      if (widget.picker.minDate != null) {
        startDate = startDate.isBefore(widget.picker.minDate) == true ? widget.picker.minDate : startDate;
      }

      _pickerStateDetails.selectedRange = widget.picker.isHijri ? HijriDateRange(startDate, endDate) : PickerDateRange(startDate, endDate);
  ...
  void _updateRangeSelectionByKeyboardNavigation(dynamic selectedDate) {
    if (_pickerStateDetails.selectedRange != null &&
        _pickerStateDetails.selectedRange.startDate != null &&
        (_pickerStateDetails.selectedRange.endDate == null || isSameDate(_pickerStateDetails.selectedRange.startDate, _pickerStateDetails.selectedRange.endDate))) {
      dynamic startDate = _pickerStateDetails.selectedRange.startDate;
      ...
      _pickerStateDetails.selectedRange = widget.picker.isHijri ? HijriDateRange(selectedDate, null) : PickerDateRange(selectedDate, null);
    }
  }
  ...
  void _updateSelectionByKeyboardNavigation(dynamic selectedDate) {
    switch (widget.picker.selectionMode) {
      ...
      case DateRangePickerSelectionMode.extendableRange:
        {
          if (_pickerStateDetails.selectedRange != null && _pickerStateDetails.selectedRange.startDate != null && _pickerStateDetails.selectedRange.endDate != null) {
            dynamic startDate = _pickerStateDetails.selectedRange.startDate;
            ...
            if (selectedDate.isAfter(endDate) == true) {
              ...
              if (widget.picker.selectionMode == DateRangePickerSelectionMode.extendableRange &&
                  widget.picker.extendableRangeSelectionDirection != ExtendableRangeSelectionDirection.both) {
                if (widget.picker.extendableRangeSelectionDirection == ExtendableRangeSelectionDirection.forward) {
                  endDate = selectedDate;
                } else if (widget.picker.extendableRangeSelectionDirection == ExtendableRangeSelectionDirection.backward) {
                  startDate = selectedDate;
  ...
  KeyEventResult _onKeyDown(FocusNode node, RawKeyEvent event) {
    ...
    if (event.isControlPressed) {
      final bool canMoveToNextView = DateRangePickerHelper.canMoveToNextViewRtl(
          pickerView,
          DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri),
    ...
    if (_pickerStateDetails.selectedDate == null &&
        ...
        _pickerStateDetails.selectedRange == null &&
        (_pickerStateDetails.selectedRanges == null || _pickerStateDetails.selectedRanges!.isEmpty)) {
      return result;
    }
    ...
    if (pickerView != DateRangePickerView.month) {
      result = _updateYearSelectionByKeyBoardNavigation(currentVisibleViewState, currentVisibleView, pickerView, event);
      return result;
    }

    final dynamic selectedDate = _updateSelectedDate(event, currentVisibleViewState, currentVisibleView);

    if (DateRangePickerHelper.isDateWithInVisibleDates(currentVisibleView.visibleDates, widget.picker.monthViewSettings.blackoutDates, selectedDate) ||
        DateRangePickerHelper.isDateWithInVisibleDates(currentVisibleView.visibleDates, currentVisibleView.disableDatePredicates, selectedDate) ||
        !DateRangePickerHelper.isEnabledDate(widget.picker.minDate, widget.picker.maxDate, widget.picker.enablePastDates, selectedDate, widget.picker.isHijri)) {
      return result;
    }
    ...
    final dynamic visibleEndDate = currentVisibleView.visibleDates[currentVisibleView.visibleDates.length - 1];
    final int datesCount = currentVisibleView.visibleDates.length ~/ (widget.picker.enableMultiView ? 2 : 1);
    // ignore: avoid_bool_literals_in_conditional_expressions
    final bool showLeadingTrailingDates =
        widget.picker.enableMultiView ? false : DateRangePickerHelper.canShowLeadingAndTrailingDates(widget.picker.monthViewSettings, widget.picker.isHijri);
    final bool isCurrentMonthDate = widget.picker.enableMultiView
        ? (DateRangePickerHelper.isDateAsCurrentMonthDate(
                currentVisibleView.visibleDates[datesCount ~/ 2], numberOfWeeksInView, showLeadingTrailingDates, selectedDate, widget.picker.isHijri) ||
            DateRangePickerHelper.isDateAsCurrentMonthDate(
                currentVisibleView.visibleDates[datesCount + (datesCount ~/ 2)], numberOfWeeksInView, showLeadingTrailingDates, selectedDate, widget.picker.isHijri))
        : DateRangePickerHelper.isDateAsCurrentMonthDate(
            currentVisibleView.visibleDates[datesCount ~/ 2], numberOfWeeksInView, showLeadingTrailingDates, selectedDate, widget.picker.isHijri);
    if (!isCurrentMonthDate || !isDateWithInDateRange(visibleStartDate, visibleEndDate, selectedDate)) {
      final int month = selectedDate.month as int;
      final dynamic nextMonthDate = getNextMonthDate(currentVisibleView.visibleDates[currentVisibleView.visibleDates.length ~/ (widget.picker.enableMultiView ? 4 : 2)]);
    ...
    widget.updatePickerStateValues(_pickerStateDetails);
    currentVisibleViewState._monthView!.selectionNotifier.value = !currentVisibleViewState._monthView!.selectionNotifier.value;
  ...
  dynamic _updateSingleSelectionByKeyBoardKeys(RawKeyEvent event, _PickerView currentView) {
    ...
    if (event.logicalKey == LogicalKeyboardKey.arrowRight) {
      if (isSameDate(_pickerStateDetails.selectedDate, currentView.visibleDates[currentView.visibleDates.length - 1])) {
        _moveToNextViewWithAnimation();
      }
      do {
        selectedDate = addDays(selectedDate, 1);
      } while (DateRangePickerHelper.isDateWithInVisibleDates(currentView.visibleDates, widget.picker.monthViewSettings.blackoutDates, selectedDate));
  ...
  dynamic _updateMultiAndRangeSelectionByKeyBoard(RawKeyEvent event, _PickerViewState currentState, _PickerView currentView) {
    dynamic selectedDate;
    if (event.isShiftPressed && event.logicalKey == LogicalKeyboardKey.arrowRight) {
      if (widget.picker.selectionMode == DateRangePickerSelectionMode.multiple) {
        selectedDate = _pickerStateDetails.selectedDates![_pickerStateDetails.selectedDates!.length - 1];
        do {
          selectedDate = addDays(selectedDate, 1);
        } while (DateRangePickerHelper.isDateWithInVisibleDates(currentView.visibleDates, widget.picker.monthViewSettings.blackoutDates, selectedDate));
        return selectedDate;
  ...
  dynamic _updateSelectedDate(RawKeyEvent event, _PickerViewState currentState, _PickerView currentView) {
    switch (widget.picker.selectionMode) {
      case DateRangePickerSelectionMode.single:
        {
      ...
      case DateRangePickerNavigationDirection.horizontal:
        {
          ...
          if (difference < 0 &&
              !DateRangePickerHelper.canMoveToNextViewRtl(pickerView, DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri),
                  widget.picker.minDate, widget.picker.maxDate, _currentViewVisibleDates, widget.isRtl, widget.picker.enableMultiView, widget.picker.isHijri)) {
            return;
          } else if (difference > 0 &&
              !DateRangePickerHelper.canMoveToPreviousViewRtl(pickerView, DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri),
                  widget.picker.minDate, widget.picker.maxDate, _currentViewVisibleDates, widget.isRtl, widget.picker.enableMultiView, widget.picker.isHijri)) {
            return;
          }
      ...
      case DateRangePickerNavigationDirection.horizontal:
        {
          ...
          // fling the view from right to left
            ...
            if (!DateRangePickerHelper.canMoveToNextViewRtl(pickerView, DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri),
                widget.picker.minDate, widget.picker.maxDate, _currentViewVisibleDates, widget.isRtl, widget.picker.enableMultiView, widget.picker.isHijri)) {
              _position = 0;
              setState(() {
          ...
          // fling the view from left to right
            ...
            if (!DateRangePickerHelper.canMoveToPreviousViewRtl(pickerView, DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri),
                widget.picker.minDate, widget.picker.maxDate, _currentViewVisibleDates, widget.isRtl, widget.picker.enableMultiView, widget.picker.isHijri)) {
              _position = 0;
              setState(() {
                /* Completes the swiping and rearrange the children position in
      ...
      case DateRangePickerNavigationDirection.vertical:
        {
          ...
          if (difference < 0 &&
              !DateRangePickerHelper.canMoveToNextView(pickerView, DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri),
                  widget.picker.maxDate, _currentViewVisibleDates, widget.picker.enableMultiView, widget.picker.isHijri)) {
            return;
          } else if (difference > 0 &&
              !DateRangePickerHelper.canMoveToPreviousView(pickerView, DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri),
                  widget.picker.minDate, _currentViewVisibleDates, widget.picker.enableMultiView, widget.picker.isHijri)) {
            return;
          }
      ...
      case DateRangePickerNavigationDirection.vertical:
        {
          ...
          // fling the view to bottom to top
            ...
            if (!DateRangePickerHelper.canMoveToNextView(pickerView, DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri),
                widget.picker.maxDate, _currentViewVisibleDates, widget.picker.enableMultiView, widget.picker.isHijri)) {
              _position = 0;
              setState(() {
                /* Completes the swiping and rearrange the children position in
          ...
          // fling the view to top to bottom
            ...
            if (!DateRangePickerHelper.canMoveToPreviousView(pickerView, DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri),
                widget.picker.minDate, _currentViewVisibleDates, widget.picker.enableMultiView, widget.picker.isHijri)) {
              _position = 0;
              setState(() {
                /* Completes the swiping and rearrange the children position in
  ...
  void _triggerSelectableDayPredicates(List<dynamic> visibleDates) {
    if ((widget.picker.selectableDayPredicate == null) ||
        (_disabledDates != null && _disabledDates!.isNotEmpty && _disabledDates?.keys != null && _disabledDates!.keys.isNotEmpty && _disabledDates!.keys.first == visibleDates)) {
      return;
    }
    ...
    switch (view) {
      case DateRangePickerView.month:
        ...
        for (int i = 0; i < viewCount; i++) {
          ...
          for (int j = i * datesCount; j < ((i + 1) * datesCount); j++) {
            final int numberOfWeeksInView = DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri);
            final bool showLeadingTrailingDates = DateRangePickerHelper.canShowLeadingAndTrailingDates(widget.picker.monthViewSettings, widget.picker.isHijri);
            final bool isCurrentMonthDate =
                DateRangePickerHelper.isDateAsCurrentMonthDate(visibleDates[midDateIndex], numberOfWeeksInView, showLeadingTrailingDates, visibleDates[j], widget.picker.isHijri);
            if (isCurrentMonthDate) {
              final bool isSelectedDayPredicate = widget.picker.selectableDayPredicate(visibleDates[j]) as bool;
      ...
      case DateRangePickerView.decade:
        ...
        for (int i = 0; i < visibleDates.length; i++) {
          final bool isSelectedDayPredicate = widget.picker.selectableDayPredicate(visibleDates[i]) as bool;
          if (!isSelectedDayPredicate) {
...
class _PickerViewState extends State<_PickerView> with TickerProviderStateMixin {
  ...
  Widget _addMonthView(Locale locale, SfDateRangePickerThemeData datePickerTheme, SfLocalizations localizations) {
    final DateRangePickerView pickerView = DateRangePickerHelper.getPickerView(widget.controller.view);
    double viewHeaderHeight = widget.picker.monthViewSettings.viewHeaderHeight as double;
    if (pickerView == DateRangePickerView.month && widget.picker.navigationDirection == DateRangePickerNavigationDirection.vertical) {
      viewHeaderHeight = 0;
    }

    final double height = widget.height - viewHeaderHeight;
    _monthView = _getMonthView(locale, widget.datePickerTheme, localizations, widget.width, height, pickerView);
    return Stack(
      children: <Widget>[
  ...
  MonthView _getMonthView(Locale locale, SfDateRangePickerThemeData datePickerTheme, SfLocalizations localizations, double width, double height, DateRangePickerView pickerView) {
    final int rowCount = DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri);
    return MonthView(
      widget.visibleDates,
      rowCount,
  ...
  Widget _getViewHeader(double viewHeaderHeight, Locale locale, SfDateRangePickerThemeData datePickerTheme) {
    if (viewHeaderHeight == 0) {
      return Positioned(left: 0, top: 0, right: 0, height: viewHeaderHeight, child: Container());
    }

    final Color todayTextColor = widget.picker.monthCellStyle.todayTextStyle != null && widget.picker.monthCellStyle.todayTextStyle!.color != null
        ? widget.picker.monthCellStyle.todayTextStyle!.color! as Color
        : (widget.picker.todayHighlightColor != null && widget.picker.todayHighlightColor != Colors.transparent
            ? widget.picker.todayHighlightColor!
    ...
    return Positioned(
      ...
      child: Container(
        color: widget.picker.monthViewSettings.viewHeaderStyle.backgroundColor ?? widget.datePickerTheme.viewHeaderBackgroundColor,
        child: RepaintBoundary(
          child: CustomPaint(
            painter: _PickerViewHeaderPainter(
                widget.visibleDates,
      ...
      case DateRangePickerView.month:
        {
          ...
          final double weekNumberPanelWidth = DateRangePickerHelper.getWeekNumberPanelWidth(widget.picker.monthViewSettings.showWeekNumber, widget.width, _isMobilePlatform);

          if (details.localPosition.dy < viewHeaderHeight ||
              ((!widget.isRtl && details.localPosition.dx < weekNumberPanelWidth) || (widget.isRtl && details.localPosition.dx > widget.width - weekNumberPanelWidth))) {
            return;
          }

          if (details.localPosition.dy > viewHeaderHeight) {
            _handleTouch(Offset(details.localPosition.dx, details.localPosition.dy - viewHeaderHeight), details);
          }
        }
        break;
      case DateRangePickerView.year:
  ...
  void _updateMouseHover(Offset globalPosition) {
    ...
    final double viewHeaderHeight = pickerView == DateRangePickerView.month && widget.picker.navigationDirection == DateRangePickerNavigationDirection.horizontal
    ...
    if (widget.picker.selectionMode == DateRangePickerSelectionMode.extendableRange &&
        ...
        case DateRangePickerView.month:
          {
            ...
            if (!DateRangePickerHelper.isEnabledDate(widget.picker.minDate, widget.picker.maxDate, widget.picker.enablePastDates, date, widget.picker.isHijri)) {
              _mouseHoverPosition.value = null;
              return;
            }
        ...
        case DateRangePickerView.century:
          {
            ...
            if (!DateRangePickerHelper.isBetweenMinMaxDateCell(
                date, widget.picker.minDate, widget.picker.maxDate, widget.picker.enablePastDates, widget.controller.view, widget.picker.isHijri)) {
              _mouseHoverPosition.value = null;
              return;
            }
          }
      ...
      if (DateRangePickerHelper.isDisableDirectionDate(
          _pickerStateDetails.selectedRange, date, widget.picker.extendableRangeSelectionDirection, pickerView, widget.picker.isHijri)) {
        _mouseHoverPosition.value = null;
        return;
      }
      ...
      range = widget.picker.isHijri ? HijriDateRange(rangeStartDate, rangeEndDate) : PickerDateRange(rangeStartDate, rangeEndDate);
    }
  ...
  GestureDragStartCallback? _getDragStartCallback() {
    ...
    if ((pickerView != DateRangePickerView.month && widget.picker.allowViewNavigation) ||
        !_isSwipeInteractionEnabled(widget.picker.monthViewSettings.enableSwipeSelection, widget.picker.navigationMode)) {
      return null;
    }
  ...
  int _getYearViewIndex(double xPosition, double yPosition) {
    ...
    if (widget.isRtl) {
      ...
      if (widget.enableMultiView && widget.picker.navigationDirection == DateRangePickerNavigationDirection.vertical) {
    ...
    index = (columnIndex * YearView.maxColumnCount) + ((rowIndex ~/ YearView.maxColumnCount) * totalDatesCount) + (rowIndex % YearView.maxColumnCount);
    return widget.enableMultiView && DateRangePickerHelper.isLeadingCellDate(index, (index ~/ totalDatesCount) * totalDatesCount, widget.visibleDates, widget.controller.view)
        ? -1
        : index;
  }
  ...
  int _getSelectedIndex(double xPosition, double yPosition) {
        ...
        case DateRangePickerNavigationDirection.horizontal:
          {
            ...
            totalColumnCount *= 2;
            if (xPosition > width / 2 && xPosition < (width / 2) + widget.picker.viewSpacing + weekNumberPanelWidth) {
              return index;
            } else if (xPosition > width / 2) {
    ...
    if (yPosition < 0 || (!widget.isRtl && xPosition < weekNumberPanelWidth) || (widget.isRtl && xPosition > widget.width - weekNumberPanelWidth)) {
      return index;
    }
    ...
    index = (columnIndex * DateTime.daysPerWeek) + ((rowIndex ~/ DateTime.daysPerWeek) * (totalRowCount * DateTime.daysPerWeek)) + (rowIndex % DateTime.daysPerWeek);
    return index;
  }
  ...
  void _dragStart(DragStartDetails details) {
    ...
    if (pickerView == DateRangePickerView.month && widget.picker.navigationDirection == DateRangePickerNavigationDirection.horizontal) {
    ...
    if (!DateRangePickerHelper.isEnabledDate(widget.picker.minDate, widget.picker.maxDate, widget.picker.enablePastDates, selectedDate, widget.picker.isHijri)) {
      return;
    }
    ...
    if (DateRangePickerHelper.isDateWithInVisibleDates(widget.visibleDates, widget.picker.monthViewSettings.blackoutDates, selectedDate) ||
        DateRangePickerHelper.isDateWithInVisibleDates(widget.visibleDates, widget.disableDatePredicates, selectedDate)) {
      return;
    }
      ...
      case DateRangePickerSelectionMode.multiRange:
        {
          ...
          _pickerStateDetails.selectedRanges!.add(widget.picker.isHijri ? HijriDateRange(selectedDate, null) : PickerDateRange(selectedDate, null));
          _removeInterceptRanges(_pickerStateDetails.selectedRanges, _pickerStateDetails.selectedRanges![_pickerStateDetails.selectedRanges!.length - 1]);
        }
        break;
      case DateRangePickerSelectionMode.extendableRange:
        _drawExtendableRangeSelection(selectedDate);
      ...
      case DateRangePickerSelectionMode.range:
        {
          ...
          if (!_isDragStart) {
            ...
            if (_pickerStateDetails.selectedRange != null && _pickerStateDetails.selectedRange.startDate != null) {
              final dynamic updatedRange = _getSelectedRangeOnDragUpdate(_pickerStateDetails.selectedRange, selectedDate);
              if (DateRangePickerHelper.isRangeEquals(_pickerStateDetails.selectedRange, updatedRange)) {
                return;
              }
      ...
      case DateRangePickerSelectionMode.multiRange:
        {
          ...
          if (!_isDragStart) {
            ...
            if (_lastRange != null && _lastRange.startDate != null) {
              final dynamic updatedRange = _getSelectedRangeOnDragUpdate(_lastRange, selectedDate);
              if (DateRangePickerHelper.isRangeEquals(_lastRange, updatedRange)) {
                return;
              }
  ...
  dynamic _getSelectedRangeOnDragUpdateYear(dynamic previousRange, dynamic selectedDate) {
    ...
    dynamic rangeStartDate = previousRangeStartDate;
    dynamic rangeEndDate = selectedDate;
    if (DateRangePickerHelper.isSameCellDates(previousRangeStartDate, _previousSelectedDate, widget.controller.view)) {
    ...
    } else if (DateRangePickerHelper.isSameCellDates(previousRangeEndDate, _previousSelectedDate, widget.controller.view)) {
    ...
    rangeEndDate = DateRangePickerHelper.getLastDate(rangeEndDate, widget.controller.view, widget.picker.isHijri);
    if (widget.picker.maxDate != null) {
      rangeEndDate = rangeEndDate.isAfter(widget.picker.maxDate) == true ? widget.picker.maxDate : rangeEndDate;
    }

    final DateRangePickerView pickerView = DateRangePickerHelper.getPickerView(widget.controller.view);
    rangeStartDate = DateRangePickerHelper.getFirstDate(rangeStartDate, widget.picker.isHijri, pickerView);
    if (widget.picker.minDate != null) {
      rangeStartDate = rangeStartDate.isBefore(widget.picker.minDate) == true ? widget.picker.minDate : rangeStartDate;
    }
  ...
  bool _isSameOrBeforeDateCell(dynamic currentMaxDate, dynamic currentDate) {
    ...
    if (pickerView == DateRangePickerView.year) {
      return (currentDate.month <= currentMaxDate.month == true && currentDate.year == currentMaxDate.year) || currentDate.year < currentMaxDate.year == true;
  ...
  bool _isSameOrAfterDateCell(dynamic currentMinDate, dynamic currentDate) {
    final DateRangePickerView pickerView = DateRangePickerHelper.getPickerView(widget.controller.view);
    if (pickerView == DateRangePickerView.year) {
      return (currentDate.month >= currentMinDate.month == true && currentDate.year == currentMinDate.year) || currentDate.year > currentMinDate.year == true;
    } else if (pickerView == DateRangePickerView.decade) {
      ...
      case DateRangePickerSelectionMode.range:
        {
          ...
          if (!_isDragStart) {
            ...
            if (_pickerStateDetails.selectedRange != null && _pickerStateDetails.selectedRange.startDate != null) {
              final dynamic updatedRange = _getSelectedRangeOnDragUpdateYear(_pickerStateDetails.selectedRange, selectedDate);
              if (DateRangePickerHelper.isRangeEquals(_pickerStateDetails.selectedRange, updatedRange)) {
                return;
              }
      ...
      case DateRangePickerSelectionMode.multiRange:
        {
          ...
          if (!_isDragStart) {
            ...
            if (_lastRange != null && _lastRange.startDate != null) {
              final dynamic updatedRange = _getSelectedRangeOnDragUpdateYear(_lastRange, selectedDate);
              if (DateRangePickerHelper.isRangeEquals(_lastRange, updatedRange)) {
                return;
              }
  ...
  void _dragStartOnYear(DragStartDetails details) {
    ...
    /// selection value is disabled based on extendable direction on
    /// drag selection.
    if (widget.picker.selectionMode == DateRangePickerSelectionMode.extendableRange && _pickerStateDetails.selectedRange != null) {
      final DateRangePickerView pickerView = DateRangePickerHelper.getPickerView(widget.controller.view);
      if (DateRangePickerHelper.isDisableDirectionDate(
          _pickerStateDetails.selectedRange, selectedDate, widget.picker.extendableRangeSelectionDirection, pickerView, widget.picker.isHijri)) {
        return;
  ...
  int _getCurrentDateIndex(int index) {
    final int datesCount = DateRangePickerHelper.getNumberOfWeeksInView(widget.picker.monthViewSettings, widget.picker.isHijri) * DateTime.daysPerWeek;
  ...
  void _drawSingleSelectionForYear(dynamic selectedDate) {
    if (widget.picker.toggleDaySelection && DateRangePickerHelper.isSameCellDates(selectedDate, _pickerStateDetails.selectedDate, widget.controller.view)) {
      selectedDate = null;
    }
  ...
  void _drawMultipleSelectionForYear(dynamic selectedDate) {
    int selectedIndex = -1;
    if (_pickerStateDetails.selectedDates != null && _pickerStateDetails.selectedDates!.isNotEmpty) {
      selectedIndex = DateRangePickerHelper.getDateCellIndex(_pickerStateDetails.selectedDates!, selectedDate, widget.controller.view);
    }
  ...
  void _drawRangeSelectionForYear(dynamic selectedDate) {
    if (_pickerStateDetails.selectedRange != null &&
        _pickerStateDetails.selectedRange.startDate != null &&
        (_pickerStateDetails.selectedRange.endDate == null ||
            DateRangePickerHelper.isSameCellDates(_pickerStateDetails.selectedRange.startDate, _pickerStateDetails.selectedRange.endDate, widget.controller.view))) {
      dynamic startDate = _pickerStateDetails.selectedRange.startDate;
      dynamic endDate = selectedDate;
      if (startDate.isAfter(endDate) == true) {
        final dynamic temp = startDate;
  ...
  void _drawRangesSelectionForYear(dynamic selectedDate) {
    ...
    if (_lastRange != null &&
        ...
        (_lastRange.endDate == null || DateRangePickerHelper.isSameCellDates(_lastRange.startDate, _lastRange.endDate, widget.controller.view))) {
      ...
      final dynamic newRange = widget.picker.isHijri ? HijriDateRange(startDate, endDate) : PickerDateRange(startDate, endDate);
    ...
    _removeInterceptRanges(_pickerStateDetails.selectedRanges, _pickerStateDetails.selectedRanges![_pickerStateDetails.selectedRanges!.length - 1]);
    _lastRange = _pickerStateDetails.selectedRanges![_pickerStateDetails.selectedRanges!.length - 1];
    if (count != _pickerStateDetails.selectedRanges!.length &&
        (_lastRange.endDate == null || DateRangePickerHelper.isSameCellDates(_lastRange.endDate, _lastRange.startDate, widget.controller.view))) {
  ...
  void _handleYearPanelSelection(Offset details) {
    ...
    if (!widget.picker.allowViewNavigation) {
      if (!DateRangePickerHelper.isBetweenMinMaxDateCell(
              date, widget.picker.minDate, widget.picker.maxDate, widget.picker.enablePastDates, widget.controller.view, widget.picker.isHijri) ||
          DateRangePickerHelper.isDateWithInVisibleDates(widget.visibleDates, widget.disableDatePredicates, date)) {
        return;
      }
      ...
      case DateRangePickerView.year:
        {
          ...
          if ((year < minYear || (year == minYear && month < minMonth)) || (year > maxYear || (year == maxYear && month > maxMonth))) {
            return;
          }
  ...
  void _drawSingleSelectionForMonth(dynamic selectedDate) {
    if (widget.picker.toggleDaySelection && isSameDate(selectedDate, _pickerStateDetails.selectedDate)) {
      selectedDate = null;
    }
  ...
  void _drawMultipleSelectionForMonth(dynamic selectedDate) {
    final int selectedIndex = DateRangePickerHelper.isDateIndexInCollection(_pickerStateDetails.selectedDates, selectedDate);
    if (selectedIndex == -1) {
      _pickerStateDetails.selectedDates ??= <dynamic>[];
      _pickerStateDetails.selectedDates!.add(selectedDate);
    } else {
  ...
  void _drawExtendableRangeSelection(dynamic selectedDate) {
    ...
    if (_pickerStateDetails.selectedRange == null) {
      ...
      _pickerStateDetails.selectedRange = widget.picker.isHijri ? HijriDateRange(startDate, null) : PickerDateRange(startDate, null);
      _lastSelectedDate = selectedDate;
      return;
    }
  ...
  void _drawRangesSelectionForMonth(dynamic selectedDate) {
    ...
    if (lastRange != null && lastRange.startDate != null && (lastRange.endDate == null || isSameDate(lastRange.startDate, lastRange.endDate))) {
      ...
      final dynamic _newRange = widget.picker.isHijri ? HijriDateRange(startDate, endDate) : PickerDateRange(startDate, endDate);
    ...
    if (count != _pickerStateDetails.selectedRanges!.length && (lastRange.endDate == null || isSameDate(lastRange.endDate, lastRange.startDate))) {
      _pickerStateDetails.selectedRanges!.removeLast();
    }
  }

  int? _removeInterceptRangesForMonth(dynamic range, dynamic startDate, dynamic endDate, int i, dynamic selectedRangeValue) {
    if (range != null &&
        !DateRangePickerHelper.isRangeEquals(range, selectedRangeValue) &&
        ((range.startDate != null && ((startDate != null && isSameDate(range.startDate, startDate)) || (endDate != null && isSameDate(range.startDate, endDate)))) ||
            (range.endDate != null && ((startDate != null && isSameDate(range.endDate, startDate)) || (endDate != null && isSameDate(range.endDate, endDate)))) ||
            (range.startDate != null &&
                range.endDate != null &&
                ((startDate != null && isDateWithInDateRange(range.startDate, range.endDate, startDate)) ||
                    (endDate != null && isDateWithInDateRange(range.startDate, range.endDate, endDate)))) ||
            (startDate != null &&
                endDate != null &&
                ((range.startDate != null && isDateWithInDateRange(startDate, endDate, range.startDate)) ||
                    (range.endDate != null && isDateWithInDateRange(startDate, endDate, range.endDate)))) ||
            (range.startDate != null &&
                range.endDate != null &&
                startDate != null &&
                endDate != null &&
                ((range.startDate.isAfter(startDate) == true && range.endDate.isBefore(endDate) == true) ||
                    (range.endDate.isAfter(startDate) == true && range.startDate.isBefore(endDate) == true))))) {
      return i;
    }
  ...
  int? _removeInterceptRangesForYear(dynamic range, dynamic startDate, dynamic endDate, int i, dynamic selectedRangeValue) {
    ...
    if (range.startDate != null &&
        ((startDate != null && DateRangePickerHelper.isSameCellDates(range.startDate, startDate, widget.controller.view)) ||
            (endDate != null && DateRangePickerHelper.isSameCellDates(range.startDate, endDate, widget.controller.view)))) {
      return i;
    }

    /// Check the range end date equal to start date or end date.
    if (range.endDate != null &&
        ((startDate != null && DateRangePickerHelper.isSameCellDates(range.endDate, startDate, widget.controller.view)) ||
            (endDate != null && DateRangePickerHelper.isSameCellDates(range.endDate, endDate, widget.controller.view)))) {
      return i;
    }
  ...
  bool _isDateWithInYearRange(dynamic startDate, dynamic endDate, dynamic date) {
    ...
    if ((DateRangePickerHelper.isSameCellDates(endDate, date, pickerView) || endDate.isAfter(date) == true) &&
        (DateRangePickerHelper.isSameCellDates(startDate, date, pickerView) || startDate.isBefore(date) == true)) {
      return true;
    }
  ...
  void _removeInterceptRanges(List<dynamic>? selectedRanges, dynamic selectedRangeValue) {
    ...
    for (int i = 0; i < selectedRanges.length; i++) {
      ...
      switch (_pickerStateDetails.view) {
        case DateRangePickerView.month:
          {
            index = _removeInterceptRangesForMonth(range, startDate, endDate, i, selectedRangeValue);
          }
          break;
        case DateRangePickerView.year:
        case DateRangePickerView.decade:
...
String _getMonthHeaderText(int startIndex, int endIndex, List<dynamic> dates, int middleIndex, int datesCount, bool isHijri, int numberOfWeeksInView, String? monthFormat,
    bool enableMultiView, DateRangePickerHeaderStyle headerStyle, DateRangePickerNavigationDirection navigationDirection, Locale locale, SfLocalizations localizations) {
  if ((!isHijri && numberOfWeeksInView != 6) && dates[startIndex].month != dates[endIndex].month) {
    ...
    if (enableMultiView && navigationDirection == DateRangePickerNavigationDirection.vertical && numberOfWeeksInView != 6 && dates[startIndex].month == dates[endIndex].month) {
      return text;
    }

    if ((enableMultiView && headerStyle.textAlign != TextAlign.center) || (enableMultiView && navigationDirection == DateRangePickerNavigationDirection.vertical)) {
...
String _getHeaderText(List<dynamic> dates, DateRangePickerView view, int index, bool isHijri, int numberOfWeeksInView, String? monthFormat, bool enableMultiView,
    DateRangePickerHeaderStyle headerStyle, DateRangePickerNavigationDirection navigationDirection, Locale locale, SfLocalizations localizations) {
  ...
  switch (view) {
    case DateRangePickerView.month:
      {
        return _getMonthHeaderText(startIndex, endIndex, dates, middleIndex, datesCount, isHijri, numberOfWeeksInView, monthFormat, enableMultiView, headerStyle,
            navigationDirection, locale, localizations);
      }
    case DateRangePickerView.year:
      {
...
Size _getTextWidgetWidth(String text, double height, double width, BuildContext context, {required TextStyle style, double widthPadding = 10, double heightPadding = 10}) {
...
bool _isSwipeInteractionEnabled(bool enableSwipeSelection, DateRangePickerNavigationMode navigationMode) {
