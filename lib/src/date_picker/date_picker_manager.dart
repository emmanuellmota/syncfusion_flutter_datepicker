...
class DateRangePickerHeaderStyle with Diagnosticable {
  ...
  const DateRangePickerHeaderStyle({this.textAlign = TextAlign.left, this.backgroundColor, this.textStyle});
  ...
  bool operator ==(dynamic other) {
    ...
    return otherStyle.textStyle == textStyle && otherStyle.textAlign == textAlign && otherStyle.backgroundColor == backgroundColor;
  }
...
class DateRangePickerMonthViewSettings with Diagnosticable {
  ...
  final String Function(int weekday)? dayFormatBuilder;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(IterableDiagnostics<DateTime>(specialDates).toDiagnosticsNode(name: 'specialDates'));
    ...
    properties.add(DiagnosticsProperty<bool>('showTrailingAndLeadingDates', showTrailingAndLeadingDates));
  ...
  @override
  int get hashCode {
    return hashValues(dayFormat, firstDayOfWeek, viewHeaderStyle, enableSwipeSelection, viewHeaderHeight, showTrailingAndLeadingDates, numberOfWeeksInView, showWeekNumber,
        weekNumberStyle, hashList(specialDates), hashList(blackoutDates), hashList(weekendDays));
  }
}
...
class DateRangePickerYearCellStyle with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<TextStyle>('disabledDatesTextStyle', disabledDatesTextStyle));
    properties.add(DiagnosticsProperty<Decoration>('disabledDatesDecoration', disabledDatesDecoration));
    ...
    properties.add(DiagnosticsProperty<Decoration>('leadingDatesDecoration', leadingDatesDecoration));
  }

  @override
  int get hashCode {
    return hashValues(
        textStyle, todayTextStyle, leadingDatesTextStyle, disabledDatesTextStyle, disabledDatesDecoration, cellDecoration, todayCellDecoration, leadingDatesDecoration);
  }
}
...
class DateRangePickerMonthCellStyle with Diagnosticable {
  ...
  const DateRangePickerMonthCellStyle({
    ...
    this.specialDatesCustomDecoration,
  });
  ...
  final BoxDecoration Function(DateTime date)? specialDatesCustomDecoration;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<TextStyle>('textStyle', textStyle));
    properties.add(DiagnosticsProperty<TextStyle>('todayTextStyle', todayTextStyle));
    properties.add(DiagnosticsProperty<TextStyle>('trailingDatesTextStyle', trailingDatesTextStyle));
    properties.add(DiagnosticsProperty<TextStyle>('leadingDatesTextStyle', leadingDatesTextStyle));
    ...
    properties.add(DiagnosticsProperty<Decoration>('cellDecoration', cellDecoration));
    properties.add(DiagnosticsProperty<Decoration>('todayCellDecoration', todayCellDecoration));
    properties.add(DiagnosticsProperty<Decoration>('trailingDatesDecoration', trailingDatesDecoration));
    properties.add(DiagnosticsProperty<Decoration>('leadingDatesDecoration', leadingDatesDecoration));
    properties.add(DiagnosticsProperty<Decoration>('blackoutDatesDecoration', blackoutDatesDecoration));
    properties.add(DiagnosticsProperty<Decoration>('weekendDatesDecoration', weekendDatesDecoration));
    properties.add(DiagnosticsProperty<Decoration>('specialDatesDecoration', specialDatesDecoration));
  }
...
class DateRangePickerController extends DateRangePickerValueChangeNotifier {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(IterableDiagnostics<DateTime>(selectedDates).toDiagnosticsNode(name: 'selectedDates'));
    properties.add(DiagnosticsProperty<PickerDateRange>('selectedRange', selectedRange));
    properties.add(IterableDiagnostics<PickerDateRange>(selectedRanges).toDiagnosticsNode(name: 'selectedRanges'));
...
typedef DateRangePickerCellBuilder = Widget Function(BuildContext context, DateRangePickerCellDetails cellDetails);
